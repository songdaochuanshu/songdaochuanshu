...
const BASE_URL$2 = "https://blog-static.openserve.cloud";
const manifest_get = defineEventHandler(async (event) => {
  try {
    const query = getQuery$1(event);
    const category = query.category;
    const manifestResp = await fetch(`${BASE_URL$2}/manifest.json`);
...
const BASE_URL$1 = "https://blog-static.openserve.cloud";
const _key__get = defineEventHandler(async (event) => {
  try {
    const params = getRouterParams(event);
    const key = decodeURIComponent(params.key);
    const resp = await fetch(`${BASE_URL$1}/${key}`);
    if (!resp.ok) {
      return {
        success: false,
...
const posts_list_get = defineEventHandler(async () => {
  try {
...
const posts_list_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
const get__key_$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: get__key_
}, Symbol.toStringTag, { value: 'Module' }));
