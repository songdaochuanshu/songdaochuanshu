declare global {
  ...
  const __buildAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.4.8_@babel+plugin-syntax-typescript@7.29.7_@babel+core@7.29.7__db0_c52ffcced1213f23d76a2dbcdefc84d3/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').buildAssetsURL
  const __publicAssetsURL: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.4.8_@babel+plugin-syntax-typescript@7.29.7_@babel+core@7.29.7__db0_c52ffcced1213f23d76a2dbcdefc84d3/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths').publicAssetsURL
  ...
  const defineAppConfig: typeof import('../../node_modules/.pnpm/@nuxt+nitro-server@4.4.8_@babel+plugin-syntax-typescript@7.29.7_@babel+core@7.29.7__db0_c52ffcced1213f23d76a2dbcdefc84d3/node_modules/@nuxt/nitro-server/dist/runtime/utils/config').defineAppConfig
  ...
  const extractSlug: typeof import('../../server/utils/blog').extractSlug
  const fetchManifest: typeof import('../../server/utils/blog').fetchManifest
  const fetchPost: typeof import('../../server/utils/blog').fetchPost
  ...
  const getPost: typeof import('../../server/utils/r2').getPost
  ...
  const listPosts: typeof import('../../server/utils/r2').listPosts
...
declare global {
  ...
  // @ts-ignore
  export type { BlogPost, Manifest } from '../../server/utils/blog'
  import('../../server/utils/blog')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/root/songdaochuanshu/node_modules/.pnpm/@nuxt+nitro-server@4.4.8_@babel+plugin-syntax-typescript@7.29.7_@babel+core@7.29.7__db0_c52ffcced1213f23d76a2dbcdefc84d3/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/root/songdaochuanshu/node_modules/.pnpm/@nuxt+nitro-server@4.4.8_@babel+plugin-syntax-typescript@7.29.7_@babel+core@7.29.7__db0_c52ffcced1213f23d76a2dbcdefc84d3/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { fetchManifest, fetchPost, extractSlug } from '/root/songdaochuanshu/server/utils/blog';
export { listPosts, getPost } from '/root/songdaochuanshu/server/utils/r2';