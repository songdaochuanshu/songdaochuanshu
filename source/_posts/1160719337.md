...
![image_2022-06-24_20220624202645](https://img2022.cnblogs.com/blog/2792815/202206/2792815-20220624214732993-1677462938.png)  
但grep是一行一行过滤的，如何过滤一整个异常栈呢？awk提供了这种功能，当将awk中RS变量指定为空，awk就会一段一段的读取并处理文本，如下：
...
一般的情况下，使用less可以更快速的查看日志，比如通过`tail -n10000`取出最近1w条日志，通过less查看，如下：

    tail -n 10000 app.log | less
    

看日志时，有一个很常见的需求，就是很多日志都是当前不需要关心的，需要将它们过滤掉，less提供`&/`的功能，可快速过滤掉不想看的日志，从而找到问题日志，如下：  
![image_2022-06-24_less_filter2](https://img2022.cnblogs.com/blog/2792815/202206/2792815-20220624214732948-1970074420.gif)  
操作步骤：
...
![image_2022-06-21_vim_filter](https://img2022.cnblogs.com/blog/2792815/202206/2792815-20220624214732973-1596702629.gif)  
操作步骤：
