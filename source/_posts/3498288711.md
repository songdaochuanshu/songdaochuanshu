...
layout: post
title: "C++日期和时间编程总结"
date: "2022-12-05T13:24:08.602Z"
---
C++日期和时间编程总结
============

![C++日期和时间编程总结](https://img2023.cnblogs.com/blog/2989634/202212/2989634-20221205150848259-1623751296.png) 在 C++11 之前，C++ 编程只能使用 C-style 日期时间库，其精度只有秒级别，这对于有高精度要求的程序来说，是不够的。但这个问题在C++11 中得到了解决，C++11 中不仅扩展了对于精度的要求，也为不同系统的时间要求提供了支持。另一方面，对于只能使用 C-style 日期时间库的程序来说，C++17 中也增加了 timespec 将精度提升到了纳秒级别。

*   [一，概述](#%E4%B8%80%E6%A6%82%E8%BF%B0)
*   [二，C-style 日期和时间库](#%E4%BA%8Cc-style-%E6%97%A5%E6%9C%9F%E5%92%8C%E6%97%B6%E9%97%B4%E5%BA%93)
    *   [2.1，数据类型](#21%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B)
    *   [2.2，函数](#22%E5%87%BD%E6%95%B0)
    *   [2.3，数据类型与函数关系梳理](#23%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B%E4%B8%8E%E5%87%BD%E6%95%B0%E5%85%B3%E7%B3%BB%E6%A2%B3%E7%90%86)
    *   [2.4，时间类型](#24%E6%97%B6%E9%97%B4%E7%B1%BB%E5%9E%8B)
        *   [2.4.1，UTC 时间](#241utc-%E6%97%B6%E9%97%B4)
        *   [2.4.2，本地时间](#242%E6%9C%AC%E5%9C%B0%E6%97%B6%E9%97%B4)
        *   [2.4.3，纪元时间](#243%E7%BA%AA%E5%85%83%E6%97%B6%E9%97%B4)
    *   [2.5，输出时间和日期](#25%E8%BE%93%E5%87%BA%E6%97%B6%E9%97%B4%E5%92%8C%E6%97%A5%E6%9C%9F)
    *   [2.6，综合示例代码](#26%E7%BB%BC%E5%90%88%E7%A4%BA%E4%BE%8B%E4%BB%A3%E7%A0%81)
*   [三，chrono 库](#%E4%B8%89chrono-%E5%BA%93)
    *   [3.1，时钟](#31%E6%97%B6%E9%92%9F)
    *   [3.2，与C-style转换](#32%E4%B8%8Ec-style%E8%BD%AC%E6%8D%A2)
    *   [3.3，时长 ratio](#33%E6%97%B6%E9%95%BF-ratio)
        *   [3.3.1，时长运算](#331%E6%97%B6%E9%95%BF%E8%BF%90%E7%AE%97)
    *   [3.4，时间间隔 duration](#34%E6%97%B6%E9%97%B4%E9%97%B4%E9%9A%94-duration)
        *   [3.4.1，时间间隔转换函数 duration\_cast](#341%E6%97%B6%E9%97%B4%E9%97%B4%E9%9A%94%E8%BD%AC%E6%8D%A2%E5%87%BD%E6%95%B0-duration_cast)
    *   [3.5，时间点 time\_point](#35%E6%97%B6%E9%97%B4%E7%82%B9-time_point)
        *   [3.5.1，时间点运算](#351%E6%97%B6%E9%97%B4%E7%82%B9%E8%BF%90%E7%AE%97)
...
能够表示时间的基本算术类型的别名，能够表示函数 `time` 返回的时间，单位为**秒**级别。
...
![image](https://img2023.cnblogs.com/blog/2989634/202212/2989634-20221205150716101-1579602229.png)
...
**纪元时间**（Epoch time）又叫做 Unix 时间或者 POSIX 时间。它表示自1970 年 1 月 1 日 00:00 UTC 以来所经过的**秒数**（不考虑闰秒）。它在操作系统和文件格式中被广泛使用。**\*\*\*\* 头文件中通过 ****time\_t**** 以秒级别表示纪元时间**。
...
![image](https://img2023.cnblogs.com/blog/2989634/202212/2989634-20221205150716542-1790041347.png)
...
![image](https://img2023.cnblogs.com/blog/2989634/202212/2989634-20221205150716965-1372638400.png)

![image](https://img2023.cnblogs.com/blog/2989634/202212/2989634-20221205150717565-445142722.png)
...
静态成员函数，返回当前时间，类型为 clock::time\_point
...
静态成员类型：是否是稳定时钟，对于 steady\_clock 来说该值一定是 true

每一个时钟类都有一个 `now()` 静态函数来获取当前时间，返回的类型由 time\_\*point 描述。**std::chrono::time\_point** 是模板类，模版类实例如：std::chrono::time\_pointstd::chrono::steady\\\_\*clock，这样写比较长，庆幸的是在 C++11 中可以通过 `auto` 关键字来自动推导变量类型。
...
system\__clock 与另外两个 clock 不一样的地方在于，它还提供了两个静态函数用来将 time\__point 与 std::time\_t 来回转换。
...
![image](https://img2023.cnblogs.com/blog/2989634/202212/2989634-20221205150718333-1263937066.png)
...
Representation type used as the type for the internal [count](https://cplusplus.com/duration::count) object.

period

The second template parameter (`Period`)

The [ratio](https://cplusplus.com/ratio) type that represents a _period_ in seconds.
...
*   [C++ 头文件内容官方英文版资料](https://cplusplus.com/reference/chrono/)