...
注意: 要准确重现本文结果，请注意确保软件版本与 [wandb 报告](#%E8%B5%84%E6%BA%90) 的一致。
...
![示意图](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202312182303484.png)
...
以下代码使用了 [LoRA 论文](https://arxiv.org/abs/2106.09685) 的推荐设置。[后文](#%E8%B6%85%E5%8F%82%E8%B0%83%E4%BC%98) 我们还将用 `wandb` 对这些超参进行调优。
...
欲了解更多信息，可以查看 [资源](#%E8%B5%84%E6%BA%90) 一节中的 Wandb 实验报告。
...
> 英文原文: [https://hf.co/blog/Lora-for-sequence-classification-with-Roberta-Llama-Mistral](https://hf.co/blog/Lora-for-sequence-classification-with-Roberta-Llama-Mistral)
> 
> 原文作者: Mehdi Iraqi
> 
