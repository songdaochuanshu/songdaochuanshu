---
layout: post
title: "CesiumJS 2022^ 源码解读[6] - 三维模型（ModelExperimental）新架构"
date: "2022-06-30T22:18:16.607Z"
---
...
*   [1\. ModelExperimental 的缓存机制](#1-modelexperimental-的缓存机制)
    *   [1.1. 缓存池 ResourceCache](#11-缓存池-resourcecache)
    *   [1.2. 缓存对象的键设计 ResourceCacheKey](#12-缓存对象的键设计-resourcecachekey)
*   [2\. 三维模型的加载与解析](#2-三维模型的加载与解析)
    *   [2.1. GltfLoader 的初步加载](#21-gltfloader-的初步加载)
    *   [2.2. GltfJsonLoader 请求并解析 glTF 的 JSON 部分](#22-gltfjsonloader-请求并解析-gltf-的-json-部分)
    *   [2.3. 状态判断](#23-状态判断)
    *   [2.4. glTF 的延迟处理机制 - 使用 ES6 Promise](#24-gltf-的延迟处理机制---使用-es6-promise)
    *   [2.5. 模型组件创建](#25-模型组件创建)
    *   [2.6. 模型场景图结构的创建](#26-模型场景图结构的创建)
    *   [2.7. 本节小结](#27-本节小结)
*   [3\. 模型的更新与 DrawCommand 创建](#3-模型的更新与-drawcommand-创建)
    *   [3.1. 创建 DrawCommand 及一些有趣的设计](#31-创建-drawcommand-及一些有趣的设计)
    *   [3.2. 可能有帮助的切入点](#32-可能有帮助的切入点)
*   [4\. 本文总结](#4-本文总结)
...
![image](https://img2022.cnblogs.com/blog/1097074/202206/1097074-20220630222815670-591876637.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202206/1097074-20220630222747178-600488183.png)
