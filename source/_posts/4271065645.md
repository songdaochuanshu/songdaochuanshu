---
layout: post
title: "10道不得不会的JavaEE面试题"
date: "2022-07-06T07:17:13.237Z"
---
10道不得不会的JavaEE面试题
=================
...
*   [JavaEE](#javaee)
    *   *   [1\. JSP 有哪些内置对象？作用分别是什么？](#1-jsp-有哪些内置对象作用分别是什么)
        *   [2\. 介绍一下 Servlet 生命周期](#2-介绍一下-servlet-生命周期)
        *   [3\. Servlet和JSP的区别和联系](#3-servlet和jsp的区别和联系)
        *   [4\. JSP的执行过程](#4-jsp的执行过程)
        *   [5\. Session和Cookie的区别和联系；说明在自己项目中如何使用？](#5-session和cookie的区别和联系说明在自己项目中如何使用)
        *   [6\. 转发和重定向的联系和区别？](#6-转发和重定向的联系和区别)
        *   [7\. 拦截器和过滤器的区别](#7-拦截器和过滤器的区别)
        *   [8\. 三次握手和四次挥手](#8-三次握手和四次挥手)
        *   [9\. TCP和UDP的区别](#9-tcp和udp的区别)
        *   [10\. 如何解决跨域问题？](#10-如何解决跨域问题)
        *   [11\. 什么是 CSRF 攻击？如何防御CSRF 攻击](#11-什么是-csrf-攻击如何防御csrf-攻击)
        *   [12\. HTTP1.0和HTTP1.1和HTTP2.0的区别](#12-http10和http11和http20的区别)
...
![JSP的9内置对象及其含义](https://img2022.cnblogs.com/blog/1326459/202207/1326459-20220705234050691-1483411467.jpg)
...
![过滤器&拦截器](https://img2022.cnblogs.com/blog/1326459/202207/1326459-20220705234049691-78174696.png)
