---
layout: post
title: "密码学系列之:PKI的证书格式表示X.509"
date: "2022-06-22T22:17:34.028Z"
---
...
*   [简介](#简介)
*   [一个证书的例子](#一个证书的例子)
*   [X.509证书的后缀](#x509证书的后缀)
    *   [.pem](#pem)
    *   [.cer, .crt, .der](#cer-crt-der)
    *   [.p7b, .p7c](#p7b-p7c)
    *   [.p12](#p12)
    *   [.pfx](#pfx)
*   [证书的层级结构和交叉认证](#证书的层级结构和交叉认证)
*   [x.509证书的使用范围](#x509证书的使用范围)
*   [总结](#总结)
...
> 更多内容请参考 [http://www.flydean.com/42-pki-x509/](http://www.flydean.com/42-pki-x509/)
> 
