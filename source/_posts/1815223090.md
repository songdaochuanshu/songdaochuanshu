---
layout: post
title: "\"\\"【发布】DDD 工程脚手架 + 一键安装分布式技术栈环境！\\"\""
date: "2023-11-07T00:59:40.244Z"
---
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-01.gif?raw=true)
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-02.png?raw=true)

*   [部署这些，2核4G差不多](https://3.cn/1K-cfT7D)
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-11.png?raw=true)

### 2\. 环境展示

![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-12.png?raw=true)

### 3\. Redis 管理

![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-13.png?raw=true)

### 4\. MySql 管理

![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-14.png?raw=true)

### 5\. MQ 管理

![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-15.png?raw=true)

### 6\. JOB 管理

![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-16.png?raw=true)
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-03.png?raw=true)
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-04.png?raw=true)
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-05.png?raw=true)
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-06.png?raw=true)

*   进入工程脚手架模块下的 README.md 点击执行 mvn clean install

#### 2.2 配置

![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-07.png?raw=true)
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-08.png?raw=true)

*   进入 Maven Archetype 如图方式创建工程。

#### 2.4 效果

![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-09.png?raw=true)
...
![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-10.png?raw=true)
...
*   资源访问；
    ...
    *   配置中心nacos：[http://127.0.0.1:8848/nacos](http://127.0.0.1:8848/nacos) - 【账号：nacos 密码：nacos】
    *   消息rocketmq：[http://127.0.0.1:8080/#/](http://127.0.0.1:8080/#/) - 【账号：admin 密码：admin】
    *   任务调度xxl-job-admin：[http://127.0.0.1:9090/xxl-job-admin/](http://127.0.0.1:9090/xxl-job-admin/) - 【账号：admin 密码：123456】
    *   缓存redis：[http://127.0.0.1:8081/](http://127.0.0.1:8081/)
    *   数据库MySQL：[http://127.0.0.1:8899/](http://127.0.0.1:8899/) - 登录数据库信息，在线直接管理数据库
...
有了工程脚手架，最好再有一套对应的实战项目学习。这样加起来锻炼，看看各个项目的模块都是如何调度的，才能更好的学习这套工程。而小傅哥的 [**DDD：实战项目**](https://bugstack.cn/md/zsxq/introduce.html) 就有这样目锻炼，包括：OpenAi 应用项目、Lottery 抽奖项目、Api网关项目、IM通信项目、SpringBoot Starter 组件项目等。

![](https://bugstack.cn/images/roadmap/tutorial/xfg-frame-archetype-17.png?raw=true)
