---
layout: post
title: "MyBatis是如何初始化的？"
date: "2022-12-22T02:36:39.794Z"
---
MyBatis是如何初始化的？
===============

> **摘要：**我们知道MyBatis和数据库的交互有两种方式有Java API和Mapper接口两种，所以MyBatis的初始化必然也有两种；那么MyBatis是如何初始化的呢？

本文分享自华为云社区《[MyBatis详解 - 初始化基本过程](https://bbs.huaweicloud.com/blogs/387071?utm_source=cnblog&utm_medium=bbs-ex&utm_campaign=other&utm_content=content)》，作者：龙哥手记 。
...
有过MyBatis使用经验的读者会知道，上述语句的作用是执行com.foo.bean.BlogMapper.queryAllBlogInfo 定义的SQL语句，返回一个List结果集。总的来说，上述代码经历了三个阶段(本系列也对应三篇文章分别讲解)：
...
![](https://pic2.zhimg.com/80/v2-82c07422ff53251b14078351442b494d_720w.webp)
...
![](https://pic2.zhimg.com/80/v2-38261ac0ea5e1404d1ea7908024cf289_720w.webp)
...
![](https://pic4.zhimg.com/80/v2-f4317fa82802aab60182ef28926b6497_720w.webp)
