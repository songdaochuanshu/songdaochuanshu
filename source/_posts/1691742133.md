...
layout: post
title: "深度学习炼丹-数据标准化"
date: "2023-02-10T23:16:30.487Z"
---
深度学习炼丹-数据标准化
============

![深度学习炼丹-数据标准化](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214448122-557320408.png) 当我们处理的数据具有不同尺度时，执行数据标准化操作是很有必要的。本文给出了数据标准化(Normalization)的定义、常用方法以及为什么要做数据标准化，并给出相关代码实现。
...
*   [一，Normalization 概述](#%E4%B8%80normalization-%E6%A6%82%E8%BF%B0)
    ...
    *   [1.3，为什么要做 Normalization](#13%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E5%81%9A-normalization)
    *   [1.4，Data Normalization 常用方法](#14data-normalization-%E5%B8%B8%E7%94%A8%E6%96%B9%E6%B3%95)
    *   [1.5，代码实现](#15%E4%BB%A3%E7%A0%81%E5%AE%9E%E7%8E%B0)
...
![机器学习任务pipeline](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214323711-416933247.png)
...
![steps_in_data_normalizationing](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214324272-1216817742.png)
...
![different scale](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214324621-951544144.png)
...
1.  **样本的各个特征的取值要符合概率分布**，即 \\(\[0,1\]\\)（也可理解为降低模型训练对**特征尺度**的敏感度）。输入数据特征取值范围和输出标签范围一样，从损失函数等高线图来分析，不做 Normalization 的训练过程会更曲折。
    ...
    ![标准化前后的损失函数等高线图的对比](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214324949-1998546911.png)
...
5.  **学习率**。
    ...
    特征数据数值范围不同，正确的梯度更新方向需要的学习率也会不同（如果梯度非常大，学习率就必须非常小），即不同神经元权重 \\(w\_1\\)、\\(w\_2\\) 所需的学习率也不同。因此，学习率（学习率初始值）的选择需要参考输入的范围，这样不如**直接将数据标准化，这样学习率就不必再根据数据范围作调整**。
...
*   \\(x\\)：原始值
*   \\(mean(x)\\)：表示变量 \\(x\\) 的均值（有些地方用 \\(\\mu =\\frac{1}{N}\\sum\_{i=1}^{N} x\_i\\)）
*   \\(\\sigma\\): 表示变量的标准差（总体标准差数学定义 \\(\\sigma = \\sqrt{\\frac{1}{N} \\sum\_{i=1}^{N}(x\_i - \\mu)^2}\\) ）
*   \\({x}'\\) 是数据缩放后的新值

经过 zero-mean Normalization 操作之后的数据正态分布函数曲线图会产生如下所示转换。

![Z-Score Normalization show](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214325322-660882019.png)

其中，正态分布函数曲线中均值和标准差值的确定参考下图。

![正态分布函数曲线中均值和标准差值的确定](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214325662-637278138.png)
...
![z_score_normalization_3_histogram](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214326061-1350734676.png)
...
![程序输出结果](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214326481-1256674161.png)
...
![normalization效果图](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214326934-1163684462.png)

2，原图和两种 normalization 操作后的图像**像素值正太分布可视化**对比图如下所示:

![normalization_dist_visual](https://img2023.cnblogs.com/blog/2989634/202302/2989634-20230210214327901-2023129484.png)
...
**本文链接**：[https://www.cnblogs.com/armcvai/p/17110367.html](https://www.cnblogs.com/armcvai/p/17110367.html)
