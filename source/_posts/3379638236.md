...
1.  技术/技巧
    1.  [枢轴微调](#%E6%9E%A2%E8%BD%B4%E5%BE%AE%E8%B0%83)
    2.  [自适应优化器](#%E8%87%AA%E9%80%82%E5%BA%94%E4%BC%98%E5%8C%96%E5%99%A8)
    3.  [推荐做法](#%E5%85%B6%E4%BB%96%E5%A5%BD%E5%81%9A%E6%B3%95) - 文本编码器学习率，自定义描述文本，数据集重复，最小信噪比 Gamma，训练集创建
2.  [实验与结果](#%E5%AE%9E%E9%AA%8C%E4%B8%8E%E7%BB%93%E6%9E%9C)
3.  推理
    1.  [Diffusers 推理](#%E6%8E%A8%E7%90%86)
    2.  [Automatic1111/ComfyUI 推理](#comfy-ui--automatic1111-%E6%8E%A8%E7%90%86)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/EECPUQ.gif)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/rvN39i.png)
...
从 hub 中选择一个已包含图像及其对应提示的数据集 - 如 [LinoyTsaban/3d\_icon](https://huggingface.co/datasets/LinoyTsaban/3d_icon)。现在要做的就是在训练参数中指定数据集的名称及文本列的名称 (在本例中列名为 "prompt"):
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/Seti0u.png)
...
*   例如，如果想让模型学到有关下面这个红色背包的知识: (该图来自 [google/dreambooth](https://huggingface.co/datasets/google/dreambooth) 数据集)
    ...
    ![](https://devrel.andfun.cn/devrel/posts/2024/02/05/C4unn0.png)
    
*   我觉得后面用户有可能给一个某人背着包的提示，因此训练集中最好有下面这样的样本:  
    ![](https://devrel.andfun.cn/devrel/posts/2024/02/05/yV477J.png)
...
6.  **先验保留损失**  
    ...
    **_用于正则化的真实图像 VS 模型生成的图像_**  
    选择类图像时，你可以在合成图像 (即由扩散模型生成) 和真实图像之间进行选择。支持使用真实图像的理由是它们提高了微调模型的真实感。另一方面，有些人也会认为使用模型生成的图像可以更好地保留模型习得的 _知识_ 及审美。
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/vYACZc.png)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/LsCOka.png)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/hfKcZ8.png)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/6h7mIu.png)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/MqVnxv.png)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/0U06no.png)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/jmlwKe.png)
...
![](https://devrel.andfun.cn/devrel/posts/2024/02/05/HG3T7h.png)
...
> 英文原文: [https://hf.co/blog/sdxl\_lora\_advanced\_script](https://hf.co/blog/sdxl_lora_advanced_script)
> 
