---
layout: post
title: "netty系列之:在netty中使用native传输协议"
date: "2022-06-29T20:21:05.737Z"
---
...
*   [简介](#简介)
*   [native传输协议的依赖](#native传输协议的依赖)
*   [netty本地传输协议的使用](#netty本地传输协议的使用)
*   [总结](#总结)
...
classifier表示的是系统架构，它的值可以是linux-x86\_64，也可以是linux-aarch\_64.
...
> 更多内容请参考 [http://www.flydean.com/52-netty-native-transport-md/](http://www.flydean.com/52-netty-native-transport-md/)
> 
