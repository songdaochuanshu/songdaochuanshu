...
作者花了 `3` 个多月的时间呕心沥血的写了一个小册[《Vue 3 技术揭秘》](https://juejin.cn/book/7146465352120008743)将会为您从头到尾的介绍 `Vue 3` 的优秀设计！

小册一方面会`对 Vue 3 核心源码做适量的精简`，让你可以只用关注核心逻辑实现；另一方面，也配了`大量的插图`，一图胜千言，可以更加生动地向你展示源码的运行机制。
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/251bcf7dd13c47d396f93312192431ed~tplv-k3u1fbpfcp-watermark.image?)

相信掌握了本小册这些模块的核心原理之后，你再去阅读 Vue 3 源码或者是解决 Vue 3 的疑难杂症时，会更加得心应手。

![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/09d2765803e947c7a7c02bdbb3fafcfa~tplv-k3u1fbpfcp-watermark.image?)