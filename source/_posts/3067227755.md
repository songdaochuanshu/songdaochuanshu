---
layout: post
title: "Dubbo 入门系列之快速部署一个微服务应用"
date: "2023-02-01T10:18:07.236Z"
---
...
![arch-service-discovery](https://img2023.cnblogs.com/other/3044349/202302/3044349-20230201141235383-1106822194.png)
...
从 [背景](#%E8%83%8C%E6%99%AF) 一节中可知，运行起 Dubbo 应用的一个大前提是部署一个注册中心，为了让本教程更易于上手，我们提供了一个基于 Apache Zookeeper 注册中心的简易启动器，如果您需要在生产环境部署注册中心，请参考[生产环境初始化](https://cn.dubbo.apache.org/)一文部署高可用的注册中心。
...
![registry](https://img2023.cnblogs.com/other/3044349/202302/3044349-20230201141237025-1850525494.png)
...
![provider](https://img2023.cnblogs.com/other/3044349/202302/3044349-20230201141238174-141318511.png)
...
![consumer](https://img2023.cnblogs.com/other/3044349/202302/3044349-20230201141239691-1782215415.png)
...
更多关于 Dubbo 服务发现模型的细节，可以参考[服务发现](https://cn.dubbo.apache.org/zh/docs3-v2/java-sdk/concepts-and-architecture/service-discovery/)一文。
...
1）启动一个注册中心，可以参考动手实践中第 3 小节的[教程](#3-%E5%90%AF%E5%8A%A8%E4%B8%80%E4%B8%AA%E7%AE%80%E6%98%93%E7%9A%84%E6%B3%A8%E5%86%8C%E4%B8%AD%E5%BF%83)
...
3）启动第一个服务提供者，可以参考动手实践中第 4 小节的[教程](#4-%E5%90%AF%E5%8A%A8%E6%9C%8D%E5%8A%A1%E6%8F%90%E4%BE%9B%E8%80%85)
...
4）启动第二个服务提供者，可以参考动手实践中第 4 小节的[教程](#4-%E5%90%AF%E5%8A%A8%E6%9C%8D%E5%8A%A1%E6%8F%90%E4%BE%9B%E8%80%85)

5）启动服务消费者，可以参考动手实践中第 5 小节的[教程](#5-%E5%90%AF%E5%8A%A8%E6%9C%8D%E5%8A%A1%E6%B6%88%E8%B4%B9%E8%80%85)。多次启动消费者可以看到返回的结果是不一样的。
