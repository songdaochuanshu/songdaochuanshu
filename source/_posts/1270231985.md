...
![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202401150813954.png)
...
![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202401150813904.png)
...
![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202401150814747.png)

我们可以看到橙色部分表示在处理后的新答案上计算的分数，其与模型原始均分的相关性更好。
...
> 英文原文: [https://hf.co/blog/leaderboard-drop-dive](https://hf.co/blog/leaderboard-drop-dive)
> 
