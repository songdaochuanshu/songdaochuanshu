---
layout: post
title: "netty系列之:netty中的核心编码器base64"
date: "2022-04-22T15:19:32.203Z"
---
...
*   [简介](#简介)
*   [netty codec的实现逻辑](#netty-codec的实现逻辑)
*   [netty中Base64的实现](#netty中base64的实现)
*   [netty中的base64编码和解码器](#netty中的base64编码和解码器)
...
其中STANDARD对应的是RFC3548也是JDK中的标准Base64,URL\_SAFE对应的是RFC3548中的base64url版本，对应的JDK中的getUrlEncode。
...
> 本文已收录于 [http://www.flydean.com/14-1-netty-codec-base64/](http://www.flydean.com/14-1-netty-codec-base64/)
> 
