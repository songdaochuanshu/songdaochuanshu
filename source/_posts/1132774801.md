---
layout: post
title: "flutter系列之:查询设备信息的利器:MediaQuery"
date: "2022-09-26T15:24:24.248Z"
---
...
*   [简介](#简介)
*   [MediaQuery详解](#mediaquery详解)
    *   [MediaQuery的属性](#mediaquery的属性)
    *   [MediaQuery的构造函数](#mediaquery的构造函数)
*   [MediaQuery的使用](#mediaquery的使用)
*   [总结](#总结)
...
> 更多内容请参考 [http://www.flydean.com/50-flutter-mediaquery/](http://www.flydean.com/50-flutter-mediaquery/)
> 
