---
layout: post
title: "网络协议之:socket协议详解之Socket和Stream Socket"
date: "2022-03-30T14:16:58.559Z"
---
...
*   [Stream Socket](#stream-socket)
    *   [使用socat创建一个TCP服务器](#使用socat创建一个tcp服务器)
    *   [使用ss检查TCP连接](#使用ss检查tcp连接)
    *   [使用nc连接socket](#使用nc连接socket)
*   [总结](#总结)
...
> 本文已收录于 [http://www.flydean.com/15-stream-socket/](http://www.flydean.com/15-stream-socket/)
> 
