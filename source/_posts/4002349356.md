---
layout: post
title: " 重新审视C# Span<T>数据结构"
date: "2022-05-07T01:22:41.840Z"
---
重新审视C# Span<T>数据结构
==================
...
2.  **类型安全**： Span 是一个泛型
3.  **内存安全**： [Span](https://github.com/dotnet/runtime/blob/main/src/libraries/System.Private.CoreLib/src/System/Span.cs)是一个`readonly ref struct`数据结构, 用于表征一段连续内存的关键属性被设置成只读readonly， 保证了所有的操作只能在这段内存内。
