...
在此之前我们已经介绍过什么是`Masa Blazor`，以及如何使用`Masa Balzor`，如果还有不了解`Masa Blazor`的同学可以看我上篇文章[【初识Masa Blazor】](https://blogs.masastack.com/2021/12/12/masa/framework/masa-blazor/1.%E5%88%9D%E8%AF%86MASA%20Blazor/)。那么今天就带大家探索一下如何在`MAUI`中使用`Masa Blazor`,那么我们先来了解一下什么是MAUI？
