...
*   [方法概述](#%E6%96%B9%E6%B3%95%E6%A6%82%E8%BF%B0)
*   [快有啥用？](#%E5%BF%AB%E6%9C%89%E5%95%A5%E7%94%A8)
*   [快速推理 SDXL LCM LoRA 模型](#%E5%BF%AB%E9%80%9F%E6%8E%A8%E7%90%86-sdxl-lcm-lora-%E6%A8%A1%E5%9E%8B)
    *   [生成质量](#%E7%94%9F%E6%88%90%E8%B4%A8%E9%87%8F)
    *   [引导比例及反向提示](#%E5%BC%95%E5%AF%BC%E6%AF%94%E4%BE%8B%E5%8F%8A%E5%8F%8D%E5%90%91%E6%8F%90%E7%A4%BA)
    *   [与标准 SDXL 模型的生成质量对比](#%E4%B8%8E%E6%A0%87%E5%87%86-sdxl-%E6%A8%A1%E5%9E%8B%E7%9A%84%E7%94%9F%E6%88%90%E8%B4%A8%E9%87%8F%E5%AF%B9%E6%AF%94)
    *   [其他模型的 LCM LoRA](#%E5%85%B6%E4%BB%96%E6%A8%A1%E5%9E%8B%E7%9A%84-lcm-lora)
    *   [Diffusers 全集成](#diffusers-%E5%85%A8%E9%9B%86%E6%88%90)
*   [测试基准](#%E6%B5%8B%E8%AF%95%E5%9F%BA%E5%87%86)
*   [已公开发布的 LCM LoRA 及 LCM 模型](#%E5%B7%B2%E5%85%AC%E5%BC%80%E5%8F%91%E5%B8%83%E7%9A%84-lcm-lora-%E5%8F%8A-lcm-%E6%A8%A1%E5%9E%8B)
*   [加分项：将 LCM LoRA 与常规 SDXL LoRA 结合起来](#%E5%8A%A0%E5%88%86%E9%A1%B9%E5%B0%86-lcm-lora-%E4%B8%8E%E5%B8%B8%E8%A7%84-sdxl-lora-%E7%BB%93%E5%90%88%E8%B5%B7%E6%9D%A5)
*   [如何训练 LCM 模型及 LCM LoRA](#%E5%A6%82%E4%BD%95%E8%AE%AD%E7%BB%83-lcm-%E6%A8%A1%E5%9E%8B%E5%8F%8A-lcm-lora)
...
在使用原始 LCM 蒸馏时，每个模型都需要单独蒸馏。而 LCM LoRA 的核心思想是只对少量适配器 ([即 LoRA 层](https://huggingface.co/docs/peft/conceptual_guides/lora)) 进行训练，而不用对完整模型进行训练。推理时，可将生成的 LoRA 用于同一模型的任何微调版本，而无需对每个版本都进行蒸馏。如果你已经迫不及待地想试试这种方法的实际效果了，可以直接跳到 [下一节](#%E5%BF%AB%E9%80%9F%E6%8E%A8%E7%90%86-sdxl-lcm-lora-%E6%A8%A1%E5%9E%8B) 试一下推理代码。如果你想训练自己的 LoRA，流程如下:
...
2.  在该模型上 [训练 LCM LoRA 模型](#%E5%A6%82%E4%BD%95%E8%AE%AD%E7%BB%83-lcm-%E6%A8%A1%E5%9E%8B%E5%8F%8A-lcm-lora)。LoRA 是一种参数高效的微调 (PEFT)，其实现成本比全模型微调要便宜得多。有关 PEFT 的更详细信息，请参阅 [此博文](https://huggingface.co/blog/zh/peft) 或 [diffusers 库的 LoRA 文档](https://huggingface.co/docs/diffusers/training/lora)。
...
![LCM LORA 微调后的 SDXL 模型用 4 步生成的图像 ](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202311201649862.jpeg)  
_LCM LORA 微调后的 SDXL 模型用 4 步生成的图像_
...
![LCM LoRA 1 至 8 步生成的图像](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202311201649264.jpeg)  
_LCM LoRA 1 至 8 步生成的图像_
...
![不同步数下的 SDXL 结果](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202311201650014.jpeg)  
_SDXL 流水线结果 (相同的提示和随机种子)，步数分别为 1、4、8、15、20、25、30 和 50_
...
![基于 Dreambooth Stable Diffusion v1.5 模型使用 LCM LoRA，4 步推理](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202311201650109.png)  
_基于 Dreambooth Stable Diffusion v1.5 模型使用 LCM LoRA，4 步推理_
...
Intel i9-10980XE CPU (共 36 核，仅用 1 核)
...
![结合两种 LoRA 以实现快速推理](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202311201650426.png)  
_标准 LoRA 和 LCM LoRA 相结合实现 4 步快速推理_
...
> 英文原文: [https://hf.co/blog/lcm\_lora](https://hf.co/blog/lcm_lora)
> 
