...
![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202310111640794.png)
...
![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202310111641929.png)
...
![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202310111641047.png)

除了提高准确性之外，transformer 模型也在持续加强其在迁移学习方面的能力，这样大家就可以节约训练时间和计算成本，更快地实现业务价值。

![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202310111641961.png)
...
![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202310111641706.png)

那如果想试试 [Big Science 项目](https://bigscience.huggingface.co/) 最新的 [零样本文本生成模型](https://huggingface.co/bigscience) 呢？

![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202310111641232.png)
...
![](https://man-archives.oss-cn-hangzhou.aliyuncs.com/goofan/202310111642743.png)

**谢谢你们**，我们才刚刚开始！

* * *

_对 Hugging Face 如何帮助你的组织构建和部署生产级机器学习解决方案感兴趣？请通过 [julsimon@huggingface.co](mailto:julsimon@huggingface.co) 联系我 (招聘、推销勿扰)。_

* * *

> 英文原文: [https://hf.co/blog/the-age-of-ml-as-code](https://hf.co/blog/the-age-of-ml-as-code)
> 
> 原文作者: Julien Simon
> 
