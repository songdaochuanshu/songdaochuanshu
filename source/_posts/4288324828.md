---
layout: post
title: "微服务生态组件之Spring Cloud LoadBalancer详解和源码分析"
date: "2022-05-08T18:21:44.276Z"
---
微服务生态组件之Spring Cloud LoadBalancer详解和源码分析
========================================

![微服务生态组件之Spring Cloud LoadBalancer详解和源码分析](https://img2022.cnblogs.com/blog/2442976/202205/2442976-20220509005923979-1375955504.png) Spring Cloud LoadBalancer是Spring Cloud官方自己提供的客户端负载均衡器,抽象和实现，用来替代Ribbon.本篇从常见使用示例开始，一步步分析源码实现原理，最后还通过一个自定义负载均衡算法加深对源码的理解
...
![image-20220505191143684](https://img-blog.csdnimg.cn/img_convert/938570a0b63b56671a862e8bda11577a.png)

查看nacos服务管理-服务列表里服务详情，可以看到3个健康的库存实例和1个订单微服务实例

![image-20220505182432182](https://img-blog.csdnimg.cn/img_convert/33fa03d937354fe00bb0bb2f3dd5c805.png)
...
![image-20220505192217715](https://img-blog.csdnimg.cn/img_convert/1fc20b1d482d2a4e3924c5707ac2ff19.png)
...
![image-20220506233248585](https://img-blog.csdnimg.cn/img_convert/ad44f363342f540b1cb1805b20be6ef0.png)
...
![image-20220506234934948](https://img-blog.csdnimg.cn/img_convert/ec48e022accfb3298069c96b7e3799e7.png)

访问订单控制器中的减库存WebClient接口，[http://localhost:4070/deductWebClient/1001/1](http://localhost:4070/deductWebClient/1001/1) ，结果返回成功

![image-20220506234627330](https://img-blog.csdnimg.cn/img_convert/5f737fc9d8806dc072ce3e1fdf983de6.png)
...
![image-20220507000930179](https://img-blog.csdnimg.cn/img_convert/3546b9913f1253a1b23039ad6f7546d1.png)
...
![image-20220507000746900](https://img-blog.csdnimg.cn/img_convert/0bc2b04d23d11bc85009c7e040900b2b.png)

关于LoadBalancer官网还提供很多其他功能，有兴趣可自行详细查阅和动手实验

![image-20220507001132987](https://img-blog.csdnimg.cn/img_convert/1d8f35933945b317a2dd71627fdfa748.png)
...
![image-20220508142236428](https://img-blog.csdnimg.cn/img_convert/c3ee7af69f54aeed5f1026823779fee8.png)
...
![image-20220508142443637](https://img-blog.csdnimg.cn/img_convert/5062f793bb2bd7f996eb944f77af7137.png)
...
![image-20220509001530634](https://img-blog.csdnimg.cn/img_convert/b5be12e0dd8d515aa07613738efab122.png)

当满足上述的条件时（@Conditional为条件注解），将自动创建LoadBalancerInterceptor并注入到RestTemplate中。

![image-20220508143752218](https://img-blog.csdnimg.cn/img_convert/676f6d81529228511c862c780b0c4532.png)

### **LoadBalancerLnterceptor**

LoadBalancerInterceptor实现了ClientHttpRequestInterceptor接口，因此也实现intercept方法，用于实现负载均衡的拦截处理。

![image-20220508144048248](https://img-blog.csdnimg.cn/img_convert/bb587d8122fee4973eba2fc00ed1af3f.png)
...
![image-20220508144435104](https://img-blog.csdnimg.cn/img_convert/a3590c0ab24cb5ee04cf1cf513724fc0.png)

对于LoadBalancerClient接口Spring Cloud LoadBalancer的提供默认实现为BlockingLoadBalancerClient

![image-20220508144750601](https://img-blog.csdnimg.cn/img_convert/256e4815a982966d7d6bfb82e0e97f67.png)
...
![image-20220508190132565](https://img-blog.csdnimg.cn/img_convert/4014445b0c2ea7189a232b5d257fb938.png)
...
![image-20220508190412076](https://img-blog.csdnimg.cn/img_convert/18f62338fdb636327fcdb2d08d33661b.png)
...
![image-20220508235128931](https://img-blog.csdnimg.cn/img_convert/f19b9fd0d246dbae37b05e67b1a79805.png)
...
![image-20220508235645313](https://img-blog.csdnimg.cn/img_convert/c8ae46d4cedb33f40939edb4f6fde542.png)
...
![image-20220509000049541](https://img-blog.csdnimg.cn/img_convert/c928dcb312df87a44c33ee77a296ee84.png)
...
![image-20220509001650781](https://img-blog.csdnimg.cn/img_convert/869a4ea9a6e1409b84c927db08cebea1.png)
...
![image-20220509003807968](https://img-blog.csdnimg.cn/img_convert/c72e3f02f7e0d5d3343f8ae9c464b69c.png)

![image-20220509003927550](https://img-blog.csdnimg.cn/img_convert/59796bbbd6b3524e32759d42b622f1bc.png)
