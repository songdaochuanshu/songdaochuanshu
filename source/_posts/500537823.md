---
layout: post
title: "OpenMP 原子指令设计与实现"
date: "2023-01-21T14:13:18.511Z"
---
OpenMP 原子指令设计与实现
================

![OpenMP 原子指令设计与实现](https://img2023.cnblogs.com/blog/2519003/202301/2519003-20230121174409501-177526274.png) 在本篇文章当中主要是深入剖析了 OpenMP 当中各种原子指令的实现原理以及分析了他们对应的汇编程序，OpenMP 在处理 #pragma omp atomic 的时候如果能够使用原子指令完成需求那就直接使用原子指令，否则的话就使用 CAS cmpxchg 指令和 while 循环完成对应的需求。
...
![](https://img2023.cnblogs.com/blog/2519003/202301/2519003-20230121174330824-2136241541.png)
