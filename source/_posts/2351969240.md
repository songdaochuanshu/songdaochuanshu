---
layout: post
title: "netty系列之:netty中的核心解码器json"
date: "2022-04-26T08:23:39.640Z"
---
...
*   [简介](#简介)
*   [java中对json的支持](#java中对json的支持)
*   [netty对json的解码](#netty对json的解码)
*   [总结](#总结)
...
ST\_INIT表示的是decode的初始状态，ST\_CORRUPTED表示的是decode中出现的异常状态。

ST\_DECODING\_NORMAL代表的是一个普通的json，如下所示：
...
ST\_DECODING\_ARRAY\_STREAM代表的是一个数组，对于数组来说，数组也是一个对象，所以数组也可以用json表示,下面就是一个常见的json数组：
...
> 本文已收录于 [http://www.flydean.com/14-3-netty-codec-json/](http://www.flydean.com/14-3-netty-codec-json/)
> 
