---
layout: post
title: "SmartIDE v0.1.18 已经发布 - 助力阿里国产IDE OpenSumi 插件安装提速10倍、Dapr和Jupyter支持、CLI k8s支持"
date: "2022-06-01T22:20:52.489Z"
---
SmartIDE v0.1.18 已经发布 - 助力阿里国产IDE OpenSumi 插件安装提速10倍、Dapr和Jupyter支持、CLI k8s支持
=============================================================================

![SmartIDE v0.1.18 已经发布 - 助力阿里国产IDE OpenSumi 插件安装提速10倍、Dapr和Jupyter支持、CLI k8s支持](https://img2022.cnblogs.com/blog/8079/202206/8079-20220601122536534-179353304.png) SmartIDE v0.1.18 已经发布，助力阿里国产IDE OpenSumi 提速10倍，Dapr和Juypter环境发布。
...
在 Sprint 16中，我们开始支持阿里蚂蚁开源的国产IDE开发框架 OpenSumi，并且在 Sprint 17 发布了 基于 [Eclipse OpenVSX Registry](https://open-vsx.org/) 的 [SmartIDE插件市场](https://smartide.cn/zh/docs/overview/marketplace/)。OpenSumi的开发团队在测试了 SmartIDE插件市场之后发现速度提升可以达到10倍以上，并将其设置为OpenSumi内默认的插件市场来源。

下图来自：[https://github.com/opensumi/core/pull/1045](https://github.com/opensumi/core/pull/1045) ，是 OpenSumi 团队的测试结果。

![OpenSumi PR](https://smartide.cn/zh/blog/2022-0519-sprint18/images/r18-opensumi01.png)
...
相关修改可以参考 [https://github.com/SmartIDE/eclipse-openvsx/issues/2](https://github.com/SmartIDE/eclipse-openvsx/issues/2)

以上PR已经在2022年5月18日合并进入OpenSumi的主分支，安装 OpenSumi 的最新版就已经可以体验插件极速安装的快感了。

*   OpenSumi 官网地址 [https://opensumi.com](https://opensumi.com/)
*   SmartIDE 插件市场地址 [https://marketplace.smartide.cn/](https://marketplace.smartide.cn/)
*   类VSCode IDE更新插件市场教程 [https://smartide.cn/zh/docs/manual/marketplace/config/](https://smartide.cn/zh/docs/manual/marketplace/config/)
...
Dapr官网 [https://dapr.io](https://dapr.io/)

![Dapr](https://smartide.cn/zh/blog/2022-0519-sprint18/images/r18-dapr.png)

SmartIDE 团队 [Sprint14](https://smartide.cn/zh/blog/2022-0309-sprint14/) 开源了包括 `.net6` 环境在内的开发者镜像相关代码，在那个时间点对于 `.net6` 技术栈的支持已经完整。这个迭代中，我们针对 `.net6` 的开发者镜像进行了改进，增加了 `VM-Like-Container` 的能力，以便可以完美支持 dapr 环境的搭建和调试。
...
![Dapr Traffice Control Sample](https://smartide.cn/zh/blog/2022-0519-sprint18/images/r18-dapr-traffic-control.gif)
...
![Dapr Traffice Control Sample](https://smartide.cn/zh/blog/2022-0519-sprint18/images/r18-dapr-traffic-control-arc.png)
...
视频地址：[https://www.bilibili.com/video/BV1iv4y1A7v4?spm\_id\_from=333.999.0.0](https://www.bilibili.com/video/BV1iv4y1A7v4?spm_id_from=333.999.0.0)

Jupyter Notebook 环境支持
---------------------

[远程工作区](https://smartide.cn/zh/docs/overview/remote-workspace/) 的一个重要优势就是可以帮助开发者更好的利用远程主机的强大算力和数据处理能力，在这个领域中 `Jupyter Notebook` 无疑是非常典型的应用类型。我们在 Sprint 18 中增加了对 `Jupyter Notebook` 的远程工作区支持，现在开发者可以使用一个简单的指令就可以启动预装 `Jupyter Notebook` 的远程工作区，并且通过 `--host` 参数将这个 工作区漫游 到任意主机或者k8s环境中。相关指令如下：
...
示例地址 [https://github.com/SmartIDE/sample-anaconda-jupyter](https://github.com/SmartIDE/sample-anaconda-jupyter)

使用这个 Notebook 对上海和北京最近的疫情数据的分析结果如下：

![Juypter Covid19 Analysis](https://smartide.cn/zh/blog/2022-0519-sprint18/images/r18-jupyter01.png)
...
![Juypter Covid19 Analysis](https://smartide.cn/zh/blog/2022-0519-sprint18/images/r18-jupyter02.png)

在适配 `Jupyter Notebook` 的过程中，SmartIDE没有修改一行产品代码，完全利用我们所提供的 [IDE配置文件](https://smartide.cn/zh/blog/2022-0510-readme-exe/) 和 [开发者镜像模版库](https://smartide.cn/zh/docs/templates/) 的能力完成。SmartIDE作为一款面向企业的B端产品，对于可扩展性能力的要求是根植于产品的设计核心。利用这种能力，企业在部署了SmartIDE之后无需进行二次开发就可以自助适配各种开发语言，工具和环境，大幅降低企业采纳远程工作区的技术门槛和实施成本。

下面的视频展示了在 SmartIDE 中使用 Jupyter Notebook 分析上海和北京疫情数据的过程：

[https://www.bilibili.com/video/BV1mZ4y1t7fj?spm\_id\_from=333.999.0.0](https://www.bilibili.com/video/BV1mZ4y1t7fj?spm_id_from=333.999.0.0)

CLI k8s 模式支持（特性预览）
------------------

SmartIDE CLI中已经增加了k8s相关指令，用户现在可以使用 `smartide start --k8s` 来完成在k8s集群中启动 [远程工作区](https://smartide.cn/zh/docs/overview/remote-workspace/) 的操作，基于 [计算器示例应用](https://github.com/idcf-boat-house/boathouse-calculator) 的启动命令如下：
