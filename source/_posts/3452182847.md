...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/e37ee4c9bab34f70bb08269bfc141b61.png)
...
![](https://img-blog.csdnimg.cn/direct/aca50e32267a4d56afe5aa6adeaa39ed.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/4a95fec3e4344fd398eabe9768473b10.png)  
点击安装之后，就可以对这个插件进行配置了。

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2d252875810346599b12655bfdd647af.png)
...
smms的官方网站是https://sm.ms/ , 如果内地用户访问不了的话，它也提供了一个额外的网站，叫做： [https://smms.app/。](https://smms.app/%E3%80%82)

注册之后，在User--》DashBoard中,可以找到API Token。

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/5a9367d8db0e4ba6905e3b3efd01a9c7.png)

把它填到PicGO的图床设置里面即可：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/ee3b5ff274b54c00a60aed236386bc83.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/49e34b19d3a541ceb1cc4a3562605566.png)

在设置部分，我们可以看到可以设置很多支持的图床配置。

这里我们选择Smms，把之前的key填上去就行了。

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/aed9d8cedb674576ac03523b724fe8fd.png)

记得要在Current中选择smms。

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2f3ffba937a441beb3e31db606cee588.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/a4cdf04d43bf42c98698bc593cb09841.png)
