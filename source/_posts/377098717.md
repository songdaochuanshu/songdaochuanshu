---
layout: post
title: "网络协议之:socket协议详解之Unix domain Socket"
date: "2022-04-06T09:17:49.470Z"
---
...
*   [简介](#简介)
*   [什么是Unix domain Socket](#什么是unix-domain-socket)
*   [使用socat来创建Unix Domain Sockets](#使用socat来创建unix-domain-sockets)
*   [使用ss命令来查看Unix domain Socket](#使用ss命令来查看unix-domain-socket)
*   [使用nc连接到Unix domain Socket服务](#使用nc连接到unix-domain-socket服务)
*   [总结](#总结)
...
> 本文已收录于 [http://www.flydean.com/17-unix-domain-socket/](http://www.flydean.com/17-unix-domain-socket/)
> 
