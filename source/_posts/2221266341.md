---
layout: post
title: "ShardingSphere-proxy-5.0.0分布式哈希取模分片实现(四)"
date: "2022-06-21T19:14:23.856Z"
---
 ...
 \- !SHARDING
   tables:
     t\_product: #需要进行分表的表名
       ...
       tableStrategy:
        standard:
           shardingColumn: product\_name # 字段名
           shardingAlgorithmName: t\_product\_HASH\_MOD
       keyGenerateStrategy:
         column: id
...
#  
   shardingAlgorithms:
     t\_product\_HASH\_MOD: # 取模名称，可自定义
       type: HASH\_MOD # 取模算法
       props:
...
![](https://img2022.cnblogs.com/blog/520237/202206/520237-20220621235458861-1992370536.png)
...
\-- 插入表数据
INSERT INTO t\_product(product\_id,product\_name) VALUES(3,'apple');
INSERT INTO t\_product(product\_id,product\_name) VALUES(2,'iphone');

四、查看数据

1、查看shardingsphere中间件t\_product表数据

![](https://img2022.cnblogs.com/blog/520237/202206/520237-20220621235709419-193671124.png)

2、查看t\_product\_0、t\_product\_1表数据，同时对数据进行了分表存储(因为配置文件中有做分表配置)

![](https://img2022.cnblogs.com/blog/520237/202206/520237-20220621235759927-28181696.png)

![](https://img2022.cnblogs.com/blog/520237/202206/520237-20220621235822841-208080864.png)