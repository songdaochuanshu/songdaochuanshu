---
layout: post
title: '面试官：在原生input上面使用v-model和组件上面使用有什么区别？'
date: "2024-04-24T01:01:35.193Z"
---
面试官：在原生input上面使用v-model和组件上面使用有什么区别？
====================================

文章解释了在原生input上面使用v-model和在组件上面使用v-model有什么区别？
...
关注公众号：`前端欧阳`，解锁我更多`vue`干货文章。还可以加我微信，私信我想看哪些`vue`原理文章，我会根据大家的反馈进行创作。  
![qrcode](https://img2024.cnblogs.com/blog/1217259/202404/1217259-20240412110336542-766386622.jpg)
