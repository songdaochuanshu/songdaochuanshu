...
layout: post
title: "进程最后的遗言"
date: "2022-10-27T16:31:02.045Z"
---
进程最后的遗言
=======

![进程最后的遗言](https://img2022.cnblogs.com/blog/2519003/202210/2519003-20221027220936606-238152191.png) 在本篇文章当中主要给大家详细介绍了僵尸进程、孤儿进程、父进程从子进程获取进程退出信息，以及他们形成的原因，并且使用实际的例子进行了验证，这一部分知识练习比较紧密，希望大家有所收获！
...
正式定义：在 Unix 或者类 Unix 操作系统当中，僵尸进程就是哪些已经完成程序的执行（完成\_exit 系统调用退出了程序），但是在内核当中还有属于这个进程的进程表项。这个表项的作用主要是让父进程读取子进程的退出状态信息 (exit status)。
...
现在执行上面的程序，得到的结果如下所示：  
![](https://img2022.cnblogs.com/blog/2519003/202210/2519003-20221027220817209-1442298953.png)
...
有页面被所在内存当中，也就是说这个页面不会被操作系统换出道对换区当中

s

表示这个进程是一个 session leader
...
程序执行结果如下所示：  
![](https://img2022.cnblogs.com/blog/2519003/202210/2519003-20221027220829682-2069655425.png)
...
![](https://img2022.cnblogs.com/blog/2519003/202210/2519003-20221027220850178-655209317.png)
...
![](https://img2022.cnblogs.com/blog/2519003/202210/2519003-20221027220858890-845301953.png)
...
上面程序执行结果如下图所示：  
![](https://img2022.cnblogs.com/blog/2519003/202210/2519003-20221027220915072-752601299.png)

可以看出我们得到了内存使用的峰值，其实我们还可以使用 time 命令去查看一个进程执行时候的这些数据值。  
![](https://img2022.cnblogs.com/blog/2519003/202210/2519003-20221027220923792-2127059992.png)
