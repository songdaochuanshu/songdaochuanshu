...
date: "2022-12-13T01:24:49.111Z"
---
Vue快速上门(3)-组件与复用
================

![Vue快速上门(3)-组件与复用](https://img2022.cnblogs.com/blog/151257/202211/151257-20221119185819258-420248247.png) Vue (读音 /vjuː/，类似于 view) 是一套用于构建用户界面的渐进式框架，同他周边的生态共同构成了一个灵活的、渐进式的前端框架。 本文内容包括模板的基本语法，及各种指令的使用，最后总结了Vue动画的使用。
