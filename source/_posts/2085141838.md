...
> *   证明 \\(S'\\in\\m{LW}\\)
>     
>     注意到 \\(S^\\star\[1\\cdots k\]\\) 一定是一个近似 LW，而让 \\(S^\\star\_k\\gets S^\\star\_k+1\\)，我们就得到了一个 LW，具体的证明请参看后文“Duval 算法求 Lyndon 分解”一章中的“引理”部分和“算法流程”部分的第二种情况，会给出一个严谨的证明
>     
