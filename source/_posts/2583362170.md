---
layout: post
title: "第2-1-3章 docker-compose安装FastDFS,实现文件存储服务"
date: "2022-11-06T23:20:17.746Z"
---
...
*   [4 docker-compose安装FastDFS](#4-docker-compose安装fastdfs)
    *   [4.1 docker-compose-fastdfs.yml](#41-docker-compose-fastdfsyml)
    *   [4.2 nginx.conf](#42-nginxconf)
    *   [4.3 storage.conf](#43-storageconf)
    *   [4.4 测试](#44-测试)
...
需要注意:  
network\_mode 必须是host, 原因是当上传文件时，tracker会把storage的IP和端口发给client，如果是bridge模式，则发送的是内网IP，client无法访问到。  
image版本根据自己实际情况选择，lastest不包含nginx服务，1.2版本的包含nginx服务，其他fasdfs镜像均没有season的精简。

![在这里插入图片描述](https://img-blog.csdnimg.cn/ecdf8413e2d84bc59df058e656680945.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/6756153a6b7447ab9e89819b76f391ae.png)