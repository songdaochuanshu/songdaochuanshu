---
layout: post
title: 'vue3早已具备抛弃虚拟DOM的能力了'
date: "2024-05-06T01:01:47.254Z"
---
vue3早已具备抛弃虚拟DOM的能力了
===================
...
然后给`transformElement`函数打个断点，`transformElement`函数在**node\_modules/@vue/compiler-core/dist/compiler-core.cjs.js**文件中。
