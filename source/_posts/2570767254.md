---
layout: post
title: "OGC WebGIS 常用服务标准（WMS/WMTS/TMS/WFS）速查"
date: "2022-07-19T05:44:46.974Z"
---
...
*   [1\. WMS 速查](#1-wms-速查)
    *   [1.1. 能力](#11-能力)
    *   [1.2. 获取地图图片举例（GetMap）](#12-获取地图图片举例getmap)
    *   [1.3. 在 CesiumJS 和 OpenLayers6 中使用 GeoServer WMS](#13-在-cesiumjs-和-openlayers6-中使用-geoserver-wms)
    *   [1.4. 获取要素信息](#14-获取要素信息)
*   [2\. WMTS 速查](#2-wmts-速查)
    *   [2.1. 轴向](#21-轴向)
    *   [2.2. 能力](#22-能力)
    *   [2.3. 示意图](#23-示意图)
    *   [2.4. 请求瓦片举例（GetTile）](#24-请求瓦片举例gettile)
    *   [2.5. 请求瓦片举例（GetTile）使用 RESTful](#25-请求瓦片举例gettile使用-restful)
    *   [2.6. 关于 GeoServer 两种获取瓦片的接口风格](#26-关于-geoserver-两种获取瓦片的接口风格)
    *   [2.7. 在 CesiumJS 和 OpenLayers6 中使用 GeoServer WMTS](#27-在-cesiumjs-和-openlayers6-中使用-geoserver-wmts)
*   [3\. TMS 速查](#3-tms-速查)
    *   [3.1. 轴向](#31-轴向)
    *   [3.2. 元数据 XML 文档](#32-元数据-xml-文档)
    *   [3.3. 请求瓦片举例](#33-请求瓦片举例)
    *   [3.3. 在 QGIS 中加载 GeoServer 的 TMS](#33-在-qgis-中加载-geoserver-的-tms)
    *   [3.4. 在 CesiumJS 和 OpenLayers6 中使用 GeoServer 的 TMS](#34-在-cesiumjs-和-openlayers6-中使用-geoserver-的-tms)
    *   [3.5. GeoServer 是否可以挂接已有的 TMS](#35-geoserver-是否可以挂接已有的-tms)
*   [4\. WFS 速查](#4-wfs-速查)
    *   [4.1. 能力](#41-能力)
    *   [4.2. 获取要素（GetFeature）及常用参数](#42-获取要素getfeature及常用参数)
    *   [4.3. 获取要素时使用过滤（Filtering）](#43-获取要素时使用过滤filtering)
    *   [4.4. 简述事务（Transaction）](#44-简述事务transaction)
    *   [4.5. 推荐与不推荐](#45-推荐与不推荐)
*   [5\. 什么是 TileMatrixSet / TileMatrix](#5-什么是-tilematrixset--tilematrix)
*   [6\. 常见地图服务接口的轴朝向](#6-常见地图服务接口的轴朝向)
    *   [① 使用 Z-order 降维编码的微软必应地图](#-使用-z-order-降维编码的微软必应地图)
    *   [② 类似 WMTS 的谷歌和 OSM](#-类似-wmts-的谷歌和-osm)
    *   [③ 百度地图](#-百度地图)
*   [参考资料](#参考资料)
...
spatial\_base:guangxi\_cities

哪个图层

bbox

104.450889587402,20.8992862701416,112.061851501465,26.3855667114258
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235305653-1819685855.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235621471-1996268123.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235629469-902677491.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235638555-1671645236.png)
...
与 WMS 的 service 意义一致

Request

GetTile

与 WMS 的 request 意义一致

Version

1.0.0

与 WMS 的 version 意义一致
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235701281-1580576306.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235731611-462871507.png)
...
指定要素的 ID 来查询，格式是“图层名.id”

typeNames

string

要查询哪个“图层”，GeoServer 是“工作空间”:“图层名”
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235756703-347221829.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235812233-68137412.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235822946-52648861.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235831394-1343097826.png)

再把原来 WMTS的瓦片搬来看看：

![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235837923-627482152.png)
...
![image](https://img2022.cnblogs.com/blog/1097074/202207/1097074-20220718235846774-1059929017.png)
