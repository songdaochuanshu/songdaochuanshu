...
![图 1: 各尺寸 BGE 模型的延迟](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/178_intel_ipex_quantization/latency.png)
...
![图 2: BGE small 模型的吞吐](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/178_intel_ipex_quantization/throughput_small.png)

![图 3: BGE base 模型的吞吐](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/178_intel_ipex_quantization/throughput_base.png)

![图 3: BGE large 模型的吞吐](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/178_intel_ipex_quantization/throughput_large.png)
...
> 英文原文: [https://huggingface.co/blog/intel-fast-embedding](https://huggingface.co/blog/intel-fast-embedding)  
