...
需要由教师模型嵌入的源句子和需要由学生模型嵌入的目标句子。可以是相同的文本。
...
> 英文原文: [https://hf.co/blog/train-sentence-transformers](https://hf.co/blog/train-sentence-transformers)
> 
> 原文作者: Tom Aarsen
> 
> 译者: innovation64
