...
layout: post
title: "\"\\"视野修炼-技术周刊第62期\\"\""
date: "2023-11-20T01:01:57.407Z"
---
视野修炼-技术周刊第62期
=============

① Vite5.0 发布！ ② Bubble - README 小组件 ③ EmojiGen - AI emoji生成 ④ 自适应文本框的 CSS 实现 ⑤ 悬赏1w$做 Rust 版 Prettier ⑥ pacquet - Rust重写pnpm ⑦ ShortbreadAI - AI 漫画生成 ⑧ ChatGot - 一个窗口调用多个模型 ⑨ 最佳AI标题、描述和关键词生成器 ⑩ YesChat.ai - 免费的GPT体验
...
1.  Vite5.0 发布！
2.  Bubble - README 小组件
3.  EmojiGen - AI emoji生成

🔧开源工具&技术资讯

4.  自适应文本框的 CSS 实现
5.  悬赏1w$做 Rust 版 Prettier
6.  pacquet - Rust重写pnpm

🤖AI工具&资讯

7.  ShortbreadAI - AI 漫画生成
8.  ChatGot - 一个窗口调用多个模型
9.  最佳AI标题、描述和关键词生成器
10.  YesChat.ai - 免费的GPT体验

**​也推荐大家关注一下最后的推荐内容（周刊的主要内容来源渠道）**

_本期内容较多，下一期开始准备额外添加一个标题速览的板块，敬请期待！🙏🏻_
...
_之前还苦于无处找这些卡片，这个可以收藏起来，常用 GitHub 的肯定有朝一日用得上_
...
_A princess and five dwarves meet in the forest（一位公主和5个矮人，在森林里相遇）_
