---
layout: post
title: "flutter系列之:flutter中可以建索引的栈布局IndexedStack"
date: "2022-10-21T19:23:35.714Z"
---
...
*   [简介](#简介)
*   [IndexedStack简介](#indexedstack简介)
*   [IndexedStack的使用](#indexedstack的使用)
*   [总结](#总结)
...
可以看到在paintStack方法中，只绘制了和index对应的\_childAtIndex这个组件，所以如果index不匹配的话，并不会展示出来。
...
最后，在Scaffold的floatingActionButton中调用\_changeIndex方法实现index的改变，最终的代码如下：
