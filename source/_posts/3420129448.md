...
使用 clangd 工具链，代码风格对齐 [Linux](https://github.com/torvalds/linux/blob/master/Documentation/process/coding-style.rst)。

Lab 1: C, Assembly, Tools, and Bootstrapping
--------------------------------------------

[Lab1](https://pdos.csail.mit.edu/6.828/2018/labs/lab1/) 主要汇编、工具链及引导部分。汇编使用 GNU 风格，可以 CS:APP 书籍进行学习。
...
posted on 2022-11-28 11:35  [小胖西瓜](https://www.cnblogs.com/shuqin/)  阅读(12)  评论(0)  [编辑](https://i.cnblogs.com/EditPosts.aspx?postid=16931760)  [收藏](javascript:void(0))  [举报](javascript:void(0))