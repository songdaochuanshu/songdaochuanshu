---
layout: post
title: "密码学系列之:使用openssl检测网站是否支持ocsp"
date: "2022-07-11T08:25:49.910Z"
---
...
*   [简介](#简介)
*   [支持OCSP stapling的网站](#支持ocsp-stapling的网站)
*   [获取服务器的证书](#获取服务器的证书)
*   [获取OCSP responder地址](#获取ocsp-responder地址)
*   [发送OCSP请求](#发送ocsp请求)
*   [一个更加简单的方法](#一个更加简单的方法)
*   [总结](#总结)
...
要校验服务器是否支持OSCP,我们首先需要获取到这个服务器的证书，可以用openssl提供的 openssl s\_client -connect来完成这个工作。
...
> 更多内容请参考 [http://www.flydean.com/44-openssl-ocsp/](http://www.flydean.com/44-openssl-ocsp/)
> 
