---
layout: post
title: "\"\\"纯前端实现 JPG 图片压缩 | canvas\\"\""
date: "2024-03-25T00:59:50.450Z"
---
纯前端实现 JPG 图片压缩 | canvas
=======================

在迭代图床应用时，需要用到图片压缩，在之前分享了使用UPNG.js 处理 PNG 图片，这里记录分享一下如何处理JPG图片，并附上完整 Demo。

> **在线 Demo 体验地址 →:** [https://demos.sugarat.top/pages/jpg-compress/](https://demos.sugarat.top/pages/jpg-compress/)
...
_当然浏览器不支持这个API的话 需要引入 `polyfill` 才行（可以从 `core-js` 中引入，或自己简单实现一下）。_
...
_参考：`browser-image-compression`, `Compressor.js`, [localResizeIMG](https://github.com/think2011/localResizeIMG)_
