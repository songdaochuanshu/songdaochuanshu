---
layout: post
title: "\"\\"\\\"\\\\"\\\\\"SSH Exporter：基于Prometheus的远程系统性能监控神器\\\\\"\\\\"\\\"\\"\""
date: "2024-08-01T01:13:20.599Z"
---
...
[English](https://github.com/2018-11-27/ssh-exporter) | 中文

介绍
--

[SSH Exporter](https://github.com/2018-11-27/ssh-exporter) 是一个基于 Prometheus 规范的监控工具，通过 SSH 协议远程收集目标服务器的系统性能数据，如 CPU 使用率、内存使用情况、磁盘和网络 I/O 等，并将这些数据暴露为 Prometheus 格式的 metrics，以便被 Prometheus Server 抓取和存储。
...
*   **问题反馈**：请在 [GitHub](https://github.com/2018-11-27/ssh-exporter) 仓库中提交 issues。
