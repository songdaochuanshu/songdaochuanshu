...
> 关于Dense层的理解，课阅读[深入理解 KERAS 中 DENSE 层参数](https://blog.csdn.net/orDream/article/details/106355491 "深入理解 KERAS 中 DENSE 层参数")
...
  而我们在使用.compile()方法来编译模型参数中损失函数loss='categorical\_crossentropy'。
