...
这里的Nuget替换，最初始版本是小伙伴俊杰同学 [J.晒太阳的猫 - 博客园 (cnblogs.com)](https://www.cnblogs.com/jasongrass) 开发的，初始版本是在VS内以扩展工具来运行。可惜我没有他的源代码，就按个人需求另外开发了一套exe的Nuget工具版本。
