...
目前还在继续改造中，也在增加一些功能。如果有问题请在[Gitee 仓库](https://gitee.com/shiramashiro/cnblogs-theme-silence)中提出问题，或者评论区下面提问。有兴趣的小伙伴可以一起加入开发哦！
...
博客侧边栏公告是主题配置项的地方，你的所有可配置选项都在这里进行：
