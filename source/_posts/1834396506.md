...
![image-20220321180951763](https://img2022.cnblogs.com/other/1992869/202203/1992869-20220324183613874-1065091864.png)
...
![image-20220321181126634](https://img2022.cnblogs.com/other/1992869/202203/1992869-20220324183614889-1483449654.png)
...
![image-20220321181247016](https://img2022.cnblogs.com/other/1992869/202203/1992869-20220324183615513-1342491098.png)
...
首先我们定义了一个变量 vertex 并给他赋值一串其他语言格式的代码字符串，这个串代码是 glsl 代码，是一个跟 c 语言很相似的代码。代码接收一个传入的二维向量 position ，然后把他执行环境中的全局变量 gl\_Position 设置成一个四维向量，这个四维向量前两个维度的分量是传入的二维向量。

接下来用 glCreateShader 创建一个着色器， VERTEX\_SHADER 常量说明这个着色器是一个顶点着色器，跟顶点着色器对应的是片元着色器，顶点着色器处理做为确定点的位置。片元着色器则对顶点构成的图形中的所有位置进行逐个处理，比如两点画一个直线，两点是顶点着色器确定的，直线是片元着色器在确定了两个点的位置之后画的。
...
![image-20220321181429987](https://img2022.cnblogs.com/other/1992869/202203/1992869-20220324183621394-334647482.png)
...
![image-20220321181511519](https://img2022.cnblogs.com/other/1992869/202203/1992869-20220324183622595-697703843.png)
...
[GPU与渲染管线：如何用WebGL绘制最简单的几何图形？](https://time.geekbang.org/column/article/63c01cb24d76d96cfd6a9ce64db6a623/share?code=CsdMNTf%2FboqZugxI1qspWwJxCaw2PUoiTwhMmOZ4Klw%3D&source=app_share " GPU与渲染管线：如何用WebGL绘制最简单的几何图形？")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
![欢迎关注凹凸实验室公众号](https://img2022.cnblogs.com/other/1992869/202203/1992869-20220324183623203-2085707592.jpg)