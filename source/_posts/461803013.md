...
3.  \-e MYSQL\_ROOT\_PASSWORD=_**12345**_ 斜体部门是你的初始密码 对应的账号是root
...
navicat直接导入 本项目sql文件夹下的数据库脚本 agileboot\_xxxxxx.sql文件  
...
2.  \--requirepass "_**12345**_" 斜体部门是你的初始密码
