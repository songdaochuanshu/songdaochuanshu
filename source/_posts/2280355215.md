---
layout: post
title: "Cesium DrawCommand [1] 不谈地球 画个三角形"
date: "2022-04-28T11:16:10.745Z"
---
...
*   [0\. 前言](#0-前言)
    *   [0.1. 源码中的 DrawCommand](#01-源码中的-drawcommand)
*   [1\. 创建](#1-创建)
    *   [1.1. 构成要素 - VertexArray](#11-构成要素---vertexarray)
    *   [1.2. 构成要素 - ShaderProgram](#12-构成要素---shaderprogram)
    *   [1.3. 构成要素 - WebGL 的统一值](#13-构成要素---webgl-的统一值)
    *   [1.4. 渲染状态对象 - RenderState](#14-渲染状态对象---renderstate)
    *   [1.5. 其它构成因子](#15-其它构成因子)
        *   [① 绘制的通道类型 - Pass](#-绘制的通道类型---pass)
        *   [② 绘制的图元类型 - WebGL 绘制常数](#-绘制的图元类型---webgl-绘制常数)
        *   [③ 离屏绘制容器 - Framebuffer](#-离屏绘制容器---framebuffer)
        *   [④ 模型坐标变换矩阵 - Matrix4](#-模型坐标变换矩阵---matrix4)
        *   [⑤ 其它](#-其它)
    *   [1.6. 我们来实践一发纯色三角形](#16-我们来实践一发纯色三角形)
*   [2\. 意义 - 自定义 Primitive（PrimitiveLike）](#2-意义---自定义-primitiveprimitivelike)
    *   [点到为止](#点到为止)
*   [3\. 参考资料](#3-参考资料)
...
![image](https://img2022.cnblogs.com/blog/1097074/202204/1097074-20220428180734733-618702469.png)
