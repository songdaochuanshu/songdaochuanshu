---
layout: post
title: "线程私有变量ThreadLocal详解"
date: "2023-02-14T13:26:48.861Z"
---
...
*   [ThreadLocal 原理](#threadlocal-原理)
    ...
    *   [get()方法](#get方法)
    *   [remove()方法](#remove方法)
*   [ThreadLocal 的Hash算法](#threadlocal-的hash算法)
*   [ThreadLocal 1.7和1.8的区别](#threadlocal-17和18的区别)
*   [ThreadLocal 的问题](#threadlocal-的问题)
    *   [ThreadLocal 内存泄露问题](#threadlocal-内存泄露问题)
        *   [为什么使用弱引用而不是强引用?](#为什么使用弱引用而不是强引用)
    *   [ThreadLocal 父子线程继承](#threadlocal-父子线程继承)
...
发表于 2023-02-14 20:05  [Booksea](https://www.cnblogs.com/booksea/)  阅读(14)  评论(0)  [编辑](https://i.cnblogs.com/EditPosts.aspx?postid=17120757)  [收藏](javascript:void(0))  [举报](javascript:void(0))