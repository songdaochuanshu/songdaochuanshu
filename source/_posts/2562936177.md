---
layout: post
title: "\"\\"\\\"\\\\"\\\\\"适用于 VitePress 的公告插件开发实记\\\\\"\\\\"\\\"\\"\""
date: "2024-09-22T01:20:43.243Z"
---
...
其中分离的第一个组件类型的就是呼声较高的 [公告插件](https://www.npmjs.com/package/vitepress-plugin-announcement)。
...
_这里只阐述关键点，详细部分将计划单独拆一篇文章进行讲解（完整的搭配插件模板 0 - 1 实现）_
...
_如果要用 JSON.stringify 处理，需要传入第二个 `replacer` 参数，对函数做特殊处理。_
