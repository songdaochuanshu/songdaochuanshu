---
layout: post
title: "\"\\"\\\"\\\\"浏览器中生成 OSS 令牌 | Web Crypto API\\\\"\\\"\\"\""
date: "2024-10-08T01:16:01.291Z"
---
浏览器中生成 OSS 令牌 | Web Crypto API
==============================

使用 Web Crypto API，btoa，spark-md5（第三方库），在前端中生成 OSS 上传令牌，支持七牛云，又拍云
...
*   HMAC\_SHA-1：基于 SHA-1 哈希算法的消息认证码，用于验证消息的完整性和真实性
...
base64 和 HMAC\_SHA-1 算法都有现成的实现，分别可以使用浏览器提供的 [btoa](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/btoa) 和 [Crypto](https://developer.mozilla.org/zh-CN/docs/Web/API/Crypto) API。
