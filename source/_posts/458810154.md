...
Google AI Dart SDK 已发布测试版，这使得你能够利用 Google 最新的 Gemini 系列 AI 模型，在 Dart 或 Flutter 应用中构建生成式 AI 功能。目前 pub.dev 上已提供 [google\_generative\_ai](https://pub.dev/packages/google_generative_ai "google_generative_ai") package。如要详细了解如何使用 Google AI Dart SDK 进行开发，你可以参阅 [此博文](https://medium.com/flutter/harness-the-gemini-api-in-your-dart-and-flutter-apps-00573e560381 "此博文")，或者直接查阅 [Dart 快速入门](https://ai.google.dev/tutorials/dart_quickstart "Dart 快速入门") 教程。
...
自上次发布以来，我们对 `two_dimensional_scrollables` package 中的 `TableView Widget` 也进行了更新。此次更新改善了其整体表现、增加了对合并单元格的支持，并且在 [Flutter 3.16 稳定版](https://docs.flutter.cn/posts/whats-new-in-flutter-3-16 "Flutter 3.16 稳定版") 发布后，采用了更多二维滚动基础组件的新功能。
...
在此次发布中，除了已支持的 flutter 和 flutter\_test package 之外，flutter\_driver package 也首次被纳入了弃用策略之中。
...
posted on 2024-09-20 22:47  [Flutter社区](https://www.cnblogs.com/flutterdev)  阅读(269)  评论(0)  [编辑](https://i.cnblogs.com/EditPosts.aspx?postid=18423420)  [收藏](javascript:void(0))  [举报](javascript:void(0))
