...
![mistralai/Mistral-7B-v0.1 在 Lambada 数据集上的预测准确度](https://github.com/huggingface/quanto/blob/main/bench/generation/charts/mistralai-Mistral-7B-v0.1_Accuracy.png?raw=true)

![mistralai/Mistral-7B-v0.1 在 Lambada 数据集上的预测准确度](https://github.com/huggingface/quanto/blob/main/bench/generation/charts/mistralai-Mistral-7B-v0.1_Perplexity.png?raw=true)
...
![mistralai/Mistral-7B-v0.1 平均词元延迟](https://github.com/huggingface/quanto/blob/main/bench/generation/charts/mistralai-Mistral-7B-v0.1_Latency__ms_.png?raw=true)
...
[quanto](https://github.com/huggingface/quanto) 中尚未支持高级的训后量化算法，但该库足够通用，因此与大多数 PTQ 优化算法兼容，如 [hqq](https://mobiusml.github.io/hqq_blog/)、[AWQ](https://github.com/mit-han-lab/llm-awq)
...
> 英文原文: [https://hf.co/blog/quanto-introduction](https://hf.co/blog/quanto-introduction)  
