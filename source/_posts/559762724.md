---
layout: post
title: " 你在终端启动的进程，最后都是什么下场？（上）"
date: "2022-11-30T13:30:48.991Z"
---
你在终端启动的进程，最后都是什么下场？（上）
======================

![ 你在终端启动的进程，最后都是什么下场？（上）](https://img2023.cnblogs.com/blog/2519003/202211/2519003-20221130144851048-208854588.png) 在本篇文章当中，主要给大家介绍我们在终端启动的进程都是怎么结束的，在我们登录终端和退出终端都发生了什么？
...
![](https://img2023.cnblogs.com/blog/2519003/202211/2519003-20221130144915219-1255671089.png)
...
从上面的函数定义来看，sigaction 和 signal 不一样的地方在于信号处理函数有三个参数，然后我们定义了三个信号 SIGINT、SIGQUIT和SIGTSTP，他们的信号处理函数都是 my\_handler 。

从上面程序的输出结果我们可以知道是进程号等于 0 的进程发送的，哎我们知道的 init 的进程号是等于 1 ，那么进程号等于 0 的进程是啥呢？  
![](https://img2023.cnblogs.com/blog/2519003/202211/2519003-20221130145000056-1605825850.webp)
...
在上面的程序当中我们给 SIGHUP 定义了一个信号处理器 my\_handler ，当进程收到 SIGHUP 信号的时候就会调用这个函数，然后往 text.txt 文件当中写入数据，我们再次查看文件就能够知道是哪个进程给前台进程组发送的信号了。
...
![](https://img2023.cnblogs.com/blog/2519003/202211/2519003-20221130144947858-1317356780.png)

我们现在再次查看 text.txt 文件当中的信息：  
![](https://img2023.cnblogs.com/blog/2519003/202211/2519003-20221130144940330-2024885406.png)
...
![](https://img2023.cnblogs.com/blog/2519003/202211/2519003-20221130144931895-1480178975.png)

我们现在来看一下 text.txt 当中的内容：  
![](https://img2023.cnblogs.com/blog/2519003/202211/2519003-20221130144924197-1549592550.png)
