---
layout: post
title: "java高级用法之:JNA中的Structure"
date: "2022-05-09T09:19:54.188Z"
---
...
*   [简介](#简介)
*   [native中的struct](#native中的struct)
*   [Structure](#structure)
*   [特殊类型的Structure](#特殊类型的structure)
    *   [结构体数组作为参数](#结构体数组作为参数)
    *   [结构体数组作为返回值](#结构体数组作为返回值)
    *   [结构体中的结构体](#结构体中的结构体)
    *   [结构体中的数组](#结构体中的数组)
    *   [结构体中的可变字段](#结构体中的可变字段)
    *   [结构体中的只读字段](#结构体中的只读字段)
...
get\_displays方法返回的是一个指向结构体数组的指针，pcount是结构体的个数。
...
> 本文已收录于 [http://www.flydean.com/08-jna-structure/](http://www.flydean.com/08-jna-structure/)
> 
