...
date: "2024-05-25T01:01:23.437Z"
---
利用英特尔 Gaudi 2 和至强 CPU 构建经济高效的企业级 RAG 应用
=======================================

![](https://img-s1.andfun.cn/devrel/posts/2024/05/24/eZHTF5.png)
...
![](https://img-s1.andfun.cn/devrel/posts/2024/05/24/Mg20u5.png)
...
![](https://img-s1.andfun.cn/devrel/posts/2024/05/24/5FT2PL.png)
...
![](https://img-s1.andfun.cn/devrel/posts/2024/05/24/Z3dhkM.png)  
![](https://img-s1.andfun.cn/devrel/posts/2024/05/24/ZrweOk.png)
...
*   H100 SXM 配置: Lambda labs 实例 gpu\_8x\_h100\_sxm5; 8 张 H100 SXM 及 2 个英特尔至强铂金 8480 CPU@2 GHz，以及 1.8TB 系统内存; 操作系统 ubuntu 20.04.6 LTS，5.15.0 内核
*   Llama2 70B 部署至 4 张卡 (查询归一化至 8 卡)。Gaudi2 使用 BF16，H100 使用 FP16
*   嵌入模型为 `BAAI/bge-base v1.5` 。测试环境: TGI-gaudi 1.2.1、TGI-GPU 1.4.5、Python 3.11.7、Langchain 0.1.11、sentence-transformers 2.5.1、langchain benchmarks 0.0.10、redis 5.0.2、cuda 12.2.r12.2/compiler.32965470\_0, TEI 1.2.0
...
> 英文原文: [https://hf.co/blog/cost-efficient-rag-applications-with-intel](https://hf.co/blog/cost-efficient-rag-applications-with-intel)
> 
