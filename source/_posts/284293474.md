---
layout: post
title: "网络协议之:redis protocol 详解"
date: "2022-11-07T16:27:23.281Z"
---
...
*   [简介](#简介)
*   [redis的高级用法](#redis的高级用法)
    *   [Redis中的pipline](#redis中的pipline)
    *   [Redis中的Pub/Sub](#redis中的pubsub)
*   [RESP protocol](#resp-protocol)
    *   [Simple Strings](#simple-strings)
    *   [Bulk Strings](#bulk-strings)
    *   [RESP Integers](#resp-integers)
    *   [RESP Arrays](#resp-arrays)
