...
layout: post
title: "\"\\"\\\"Groovy初学者指南\\\"\\"\""
date: "2023-10-14T00:56:40.293Z"
---
Groovy初学者指南
===========

![Groovy初学者指南](https://img2023.cnblogs.com/blog/2129477/202310/2129477-20231013181640465-558973558.png) Groovy是一种基于Java平台的动态编程语言，它结合了Python、Ruby和Smalltalk等语言的特性，同时与Java无缝集成
...
*   [Groovy语法](#groovy语法)
    ...
    *   [集合与迭代](#集合与迭代)
        ...
        *   [处理集合的便捷方法](#处理集合的便捷方法)
    *   [异常处理](#异常处理)
*   [在Java中使用GroovyShell运行Groovy](#在java中使用groovyshell运行groovy)
    *   [添加Maven依赖](#添加maven依赖)
    *   [Binding](#binding)
    *   [CompilationCustomizer](#compilationcustomizer)
    *   [GroovyClassLoader](#groovyclassloader)
*   [Groovy生态系统](#groovy生态系统)
    *   [构建工具 - Gradle](#构建工具---gradle)
    *   [Web开发框架 - Grails](#web开发框架---grails)
    *   [测试框架 - Spock](#测试框架---spock)
*   [总结](#总结)
