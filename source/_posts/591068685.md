...
date: "2022-09-09T02:17:32.483Z"
---
Dart 2.18 正式发布
--------------

_互操作性增强、平台特定的网络组件、优化类型推断，以及空安全语言里程碑的近期更新_

_文/ Michael Thomsen, Google Flutter & Dart 产品经理_

Dart 2.18 稳定版也随着 Flutter 3.3 稳定版一起发布，本次更新带来了 Dart 与 Objective-C & Swift 互操作特性的预览版，以及根据这个特性构建的 iOS/macOS 网络组件的 package。新的 Dart 还包括泛型方法的类型推断优化、异步代码的性能提升、pub.dev 新的功能，以及对我们工具和核心库的一些调整。
...
空安全自 2020 年 11 月 Beta 版发布、2021 年 3 月随着 [Dart 2.12](https://mp.weixin.qq.com/s/OA0bTnR9o4eN_hyxTqaayA) 正式推出以来，我们很高兴看到空安全已被广泛使用。
...
> **原文链接**:
> 
> [https://medium.com/dartlang/dart-2-18-f4b3101f146c](https://medium.com/dartlang/dart-2-18-f4b3101f146c)
> 
> **本地化**: CFUG 团队: @chenglu、@Vadaski、@MeandNi、@Realank
> 
> **中文链接**:
> 
> [https://flutter.cn/posts/dart-2-18](https://flutter.cn/posts/dart-2-18)

posted on 2022-09-08 20:32  [Flutter社区](https://www.cnblogs.com/flutterdev/)  阅读(116)  评论(0)  [编辑](https://i.cnblogs.com/EditPosts.aspx?postid=16670802)  [收藏](javascript:void(0))  [举报](javascript:void(0))