---
layout: post
title: "浅析 SeaweedFS 与 JuiceFS 架构异同"
date: "2023-02-10T07:15:44.262Z"
---
...
![](https://upload-images.jianshu.io/upload_images/27037314-614f8f114ff42e9f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/27037314-1d724585fc2aef09.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/27037314-e30cdec0617362dc.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
SeaweedFS 与 JuiceFS 都支持通过外部数据库以存储文件系统的元数据信息。在数据库支持层面，SeaweedFS 支持多达 [24 种](https://github.com/seaweedfs/seaweedfs/wiki/Filer-Stores)数据库。 JuiceFS 对数据库事务能力要求高（见下文），当前支持了 3 类共 10 种事务型数据库。
...
JuiceFS [完全兼容 POSIX](https://juicefs.com/docs/zh/community/posix_compatibility)， 而 SeaweedFS 目前只实现了部分的 POSIX 兼容（[「Issue 1558」](https://github.com/seaweedfs/seaweedfs/issues/1588) 与 [Wiki](https://github.com/seaweedfs/seaweedfs/wiki/FUSE-Mount)），功能还持续完善中。
