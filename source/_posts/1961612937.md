---
layout: post
title: "深入理解 python 虚拟机：pyc 文件结构"
date: "2023-03-29T01:14:57.947Z"
---
深入理解 python 虚拟机：pyc 文件结构
========================

![深入理解 python 虚拟机：pyc 文件结构](https://img2023.cnblogs.com/blog/2519003/202303/2519003-20230328184349851-1483846799.png) 在本篇文章当中主要给大家介绍一下 .py 文件在被编译之后对应的 pyc 文件结构，pyc 文件当中的一个核心内容就是 python 字节码。
