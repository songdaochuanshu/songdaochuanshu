...
为了把用户的消息转成 LLM 所需的提示，大多数 LLM 分词器中都提供了一个名为 [chat\_template](https://huggingface.co/docs/transformers/chat_templated) 的成员属性。
...
> 英文原文: [https://hf.co/blog/langchain](https://hf.co/blog/langchain)
> 
