...
直到读到了这篇文章文章 [Introducing C# Source Generators](https://devblogs.microsoft.com/dotnet/introducing-c-source-generators/)，文中提供了一种新的解决方案，即通过`Roslyn`的`Source Generator`在编译时直接读取当前项目中的语法树，处理并生成的新代码，然后在编译时也使用这些新代码。
