---
layout: post
title: "灵感乍现！造了个与众不同的Dubbo注册中心扩展轮子"
date: "2022-04-28T02:12:01.258Z"
---
...
![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095203626-1441237948.png)
...
![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095211494-1190091218.png)

发现除了dubbo-registry-multicast之外都是依赖了第三方服务，所以这个multicast是啥呢？dubbo官方文档说的很清楚：

![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095216445-1645937769.png)
...
![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095222928-34813522.png)
...
![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095228691-1824262819.png)

其次每个文件的内容怎么组织？最简单的就是将dubbo注册的URL直接写入文件，每行一个URL，就像这样：

![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095237413-1636155920.png)
...
> [https://dubbo.apache.org/zh/docs/v2.7/dev/impls/registry/](https://dubbo.apache.org/zh/docs/v2.7/dev/impls/registry/)

虽然我觉得看完了文档你也不一定能实现一个dubbo注册中心扩展，但别慌，先往下看，说不定看完了本文你也能自己写一个。

先看一下代码结构：

![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095243741-1736444328.png)
...
![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095258389-894408559.png)

感觉和自己写没啥差别，所以我就自己写了。

完整代码已经上传到了github：

> [https://github.com/lkxiaolou/dubbo-registry-mock](https://github.com/lkxiaolou/dubbo-registry-mock)

为了让这个项目看起来更饱满一点，还写了一个README：

![image](https://img2022.cnblogs.com/blog/2379072/202204/2379072-20220428095305438-1868581958.png)
