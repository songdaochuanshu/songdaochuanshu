...
date: "2022-09-05T17:23:49.099Z"
---
v-if和v-for的优先级是什么？
==================

![](https://img2022.cnblogs.com/blog/1403020/202209/1403020-20220905164136776-1020738492.png)
...
4.  如果条件出现在循环内部，可通过计算属性`computed`提前过滤掉那些不需要显示的项
5.  computed: {
        items: function() {
