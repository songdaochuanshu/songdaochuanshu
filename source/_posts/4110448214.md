---
layout: post
title: "如何用 UDP 实现可靠传输？"
date: "2022-06-06T16:27:29.960Z"
---
如何用 UDP 实现可靠传输？
===============
...
![Packet Header](https://img-blog.csdnimg.cn/bcf3ccb6a15c4cdebe1cd0527fdd9a5e.png)Packet Header
...
![TCP 重传的歧义问题](https://img-blog.csdnimg.cn/7e4e778413c1452bb6d58ec3d5452316.png)TCP 重传的歧义问题
...
![](https://pic2.zhimg.com/80/v2-60985053d9de4e8e74042c33587ec35d_1440w.jpg)
...
![可用窗口耗尽](https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost2/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BD%91%E7%BB%9C/TCP-%E5%8F%AF%E9%9D%A0%E7%89%B9%E6%80%A7/17.jpg?)可用窗口耗尽

接着，当发送方收到对第 `32~36` 字节的 ACK 确认应答后，则**滑动窗口往右边移动 5 个字节，因为有 5 个字节的数据被应答确认**，接下来第 `52~56` 字节又变成了可用窗口，那么后续也就可以发送 `52~56` 这 5 个字节的数据了。

![32 ~ 36 字节已确认](https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost2/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BD%91%E7%BB%9C/TCP-%E5%8F%AF%E9%9D%A0%E7%89%B9%E6%80%A7/18.jpg)32 ~ 36 字节已确认
...
![](https://tva1.sinaimg.cn/large/e6c9d24ely1gzgsynf4nnj214e0goq4x.jpg)
...
![接收窗口](https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost2/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BD%91%E7%BB%9C/TCP-%E5%8F%AF%E9%9D%A0%E7%89%B9%E6%80%A7/20.jpg)接收窗口
...
![HTTP/2](https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost4@main/%E7%BD%91%E7%BB%9C/http2/stream2.png)HTTP/2
...
![](https://pic4.zhimg.com/80/v2-9e649330ab729b6438a8586c8b4f1bd3_1440w.jpg)
...
![接收窗口触发的滑动](https://img-blog.csdnimg.cn/bbde0c66088f439b919a6d18b389aadb.png)接收窗口触发的滑动
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/066cba5b7f8e45648ff0165430a42068~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)

31、32、34数据包先到达，基于 offset 被优先乱序确认，但 30 数据包没有确认，所以当前已提交的字节偏移量不变，发送方的缓存区不变。

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7292c0d343074abb8e18bf509b87998d~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)img

30 到达并确认，发送方的缓存区收缩到阈值，接收方发送 MAX\_STREAM\_DATA Frame（协商缓存大小的特定帧）给发送方，请求增长最大绝对字节偏移量。

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/39f829a7f49b42fda21dfac224457e02~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)img

协商完毕后最大绝对字节偏移量右移，发送方的缓存区变大，同时发送方发现数据包33超时

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c929bcff8fcb48c5bf7b18067faf5c80~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)img

发送方将超时数据包重新编号为 42 继续发送

![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6b6d41ee36bc42ef92f68ad46a994b00~tplv-k3u1fbpfcp-zoom-in-crop-mark:1304:0:0:0.awebp)img
...
![Connection 流量控制](https://img-blog.csdnimg.cn/839501cffa7146cbb8d992264594e61d.png)Connection 流量控制
