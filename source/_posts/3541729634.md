---
layout: post
title: "CesiumJS 2022^ 原理[2] 渲染架构之 Primitive - 创建并执行指令"
date: "2022-04-11T13:29:12.717Z"
---
...
既然通道的绘制是有顺序的，其顺序保存在 `Renderer/Pass.js` 模块导出的冻结对象中，目前（1.92版本）有 9 个优先顺序等级（最后 `NUMBER_OF_PASSES` 是通道的数量）：
