...
项目地址：[https://github.com/0xlane/com-process-inject](https://github.com/0xlane/com-process-inject)

Process Injection via Component Object Model (COM) IRundown::DoCallback().

该技术由 [@modexpblog](https://twitter.com/modexpblog) 挖掘发现，在我对该技术进行深入研究过程中，将原项目 [mdsecactivebreach/com\_inject](https://github.com/mdsecactivebreach/com_inject) 使用了 Rust 重写，希望对使用 Rust 的安全人员在 COM 接口调用、进程注入等方面有所帮助。
...
let p: \*mut IUnknown = ptr::null\_mut();
...
![x](https://github.com/0xlane/com-process-inject/blob/master/assets/Snipaste_2023-01-17_15-14-29.png?raw=true)

然后在 Processes -> All Proccess -> By Name 打开 COM 进程列表，搜索 `IRundown`:

![x](https://github.com/0xlane/com-process-inject/blob/master/assets/Snipaste_2023-01-17_15-11-08.png?raw=true)
