...
关于上述第1、2 点的作用, 我们已经在[服务引擎一章](/source/startup/engine.html#%E6%9C%8D%E5%8A%A1%E5%BC%95%E6%93%8E%E7%9A%84%E4%BD%9C%E7%94%A8)中做了详细的解析;关于第3、4点的作用,应用程序是如何在启动时调用`Initialize()`方法或是在停止时执行`Shutdown()`方法呢?

在[构建服务引擎](/source/startup/engine.html#%E6%9E%84%E5%BB%BA%E6%9C%8D%E5%8A%A1%E5%BC%95%E6%93%8E)一章中,我们提到,在构建服务引擎时,我们有一项很重要的工作就是注册了[InitSilkyHostedService](https://github.com/liuhll/silky/blob/main/framework/src/Silky.Core/InitSilkyHostedService.cs)[后台任务](https://learn.microsoft.com/zh-cn/aspnet/core/fundamentals/host/hosted-services?view=aspnetcore-6.0&tabs=visual-studio)。
...
在之前的[构建服务引擎](/source/startup/engine.html#%E6%9E%84%E5%BB%BA%E6%9C%8D%E5%8A%A1%E5%BC%95%E6%93%8E)的一章中,我们知道在`AddSilkyServices<T>()`方法中,我们通过泛型`T`来指定应用程序的启用模块`StartUpModule`类型。并构建了模块加载器对象`ModuleLoader`,并且将模块加载器对象作为服务引擎的`LoadModules()`方法参数:
...
![img](https://img2022.cnblogs.com/blog/2583122/202210/2583122-20221028092308606-738299499.png)
