...
*   [Re:从零开始教你使用 Sublime Text](#re从零开始教你使用-sublime-text)
    ...
    *   [1.安装和基础功能介绍](#1安装和基础功能介绍)
        *   [1-0.下载](#1-0下载)
        *   [1-1.有用的快捷键和特性们](#1-1有用的快捷键和特性们)
        *   [1-2.各部分功能介绍](#1-2各部分功能介绍)
            *   [1-2-0.代码编辑区](#1-2-0代码编辑区)
            *   [1-2-1.侧边栏](#1-2-1侧边栏)
            *   [1-2-2.底栏](#1-2-2底栏)
            *   [1-2-3.菜单栏](#1-2-3菜单栏)
        *   [1-3.命令面板](#1-3命令面板)
    ...
    *   [3.插件](#3插件)
        *   [3-0.如何安装插件](#3-0如何安装插件)
        *   [3-1.汉化插件](#3-1汉化插件)
        *   [3-2.美化插件](#3-2美化插件)
            *   [3-2-0.A File Icon](#3-2-0a-file-icon)
            *   [3-2-1.Transparency](#3-2-1transparency)
            *   [3-2-2.RainbowBrackets](#3-2-2rainbowbrackets)
            *   [3-2-3.BracketHighLighter](#3-2-3brackethighlighter)
            *   [3-2-4.主题+配色方案：Material Theme](#3-2-4主题配色方案material-theme)
            *   [3-2-5.主题+配色方案：ayu](#3-2-5主题配色方案ayu)
            *   [3-2-6.主题+配色方案：Theme - Spacegray](#3-2-6主题配色方案theme---spacegray)
            *   [3-2-7.主题+配色方案：One](#3-2-7主题配色方案one)
            *   [3-2-8.配色方案：Dark Knight Color Scheme](#3-2-8配色方案dark-knight-color-scheme)
            *   [3-2-9.配色方案：Darcula Color Scheme](#3-2-9配色方案darcula-color-scheme)
            *   [3-2-10.主题+配色方案：Guna](#3-2-10主题配色方案guna)
        *   [3-3.Terminus](#3-3terminus)
        *   [3-4.Typewriter](#3-4typewriter)
        *   [3-5.Origami](#3-5origami)
        *   [3-6.CppFastOlympicCoding](#3-6cppfastolympiccoding)
        *   [3-7.Vintage](#3-7vintage)
    *   [4.后记](#4后记)
    *   [5.参考](#5参考)
