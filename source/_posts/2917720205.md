---
layout: post
title: "17张图带你深度剖析 ArrayDeque（JDK双端队列）源码"
date: "2022-07-15T09:18:22.954Z"
---
17张图带你深度剖析 ArrayDeque（JDK双端队列）源码
================================

![17张图带你深度剖析 ArrayDeque（JDK双端队列）源码](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010806840-1711024784.png) 17张图带你深入了解双端队列ArrayDeque内部原理，ArrayDeque内部精妙设计，简直令人拍案叫绝！！！！！
...
*   数据从双端队列左侧进入。  
    ![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010240213-53854980.png)
    
*   数据从双端队列右侧进入。
    

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010252126-1826307061.png)

*   数据从双端队列左侧弹出。

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010301487-776744017.png)

*   数据从双端队列右侧弹出。

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010309883-1995537091.png)
...
![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010318405-150064473.png)

其中`tail`指的位置没有数据，`head`指的位置存在数据。

*   当我们需要从左往右增加数据时（入队），内存当中数据变化情况如下：

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010328930-112988730.png)

*   当我们需要从右往做左增加数据时（入队），内存当中数据变化情况如下：

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010339150-1082019999.png)

*   当我们需要从右往左删除数据时（出队），内存当中数据变化情况如下：

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010352215-1154696099.png)

*   当我们需要从左往右删除数据时（出队），内存当中数据变化情况如下：

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010402157-1785624671.png)
...
![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010411659-2092334733.png)

上图当中队列左侧的如队顺序是0, 1, 2, 3，右侧入队的顺序为15, 14, 13, 12, 11, 10, 9, 8，因此在逻辑上我们的队列当中的数据布局如下图所示：

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010417870-199598505.png)

根据前面一小节谈到的输入在入队的时候数组当中数据的变化我们可以知道，数据在数组当中的布局为：

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010426207-1011366857.png)
...
![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010441823-155207816.png)  
![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010453068-1337335447.png)

从上图当中我们会发现，我们在一个数的二进制数的32位放一个`1`，经过移位之后最终`32`位的比特数字全部变成了`1`。根据上面数字变化的规律我们可以发现，任何一个比特经过上面移位的变化，这个比特后面的`31`个比特位都会变成`1`，像下图那样：

![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010508126-385222087.png)
...
![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010517486-920930174.png)
...
![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010528021-1886913012.png)
...
以上就是本篇文章的所有内容了，希望大家有所收获，我是LeHung，我们下期再见！！！都看到这里了，给孩子一个赞（start）吧，![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010550720-87452640.png)![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010550720-87452640.png)![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010550720-87452640.png)免费的哦![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010550720-87452640.png)![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010550720-87452640.png)![](https://img2022.cnblogs.com/blog/2519003/202207/2519003-20220715010550720-87452640.png)!!!
