...
前提条件当然是先下载 blog-auto-publishing-tools这个博客自动发布工具,地址如下：[https://github.com/ddean2009/blog-auto-publishing-tools](https://github.com/ddean2009/blog-auto-publishing-tools)
...
所有的发布器都在publisher目录下，在下面你可以找到oschina\_publisher这个专门给oschina的发布器。
...
这个工具不同于传统的text或者textArea，他里面的元素是随着你的输入动态变化的，所以这里很难像传统的页面一样直接使用send\_keys来填充内容。

那么我们怎么向CodeMirror输入内容呢？

既然send\_keys不行，我们可以换一个思路，比如借助系统自带的复制和粘贴功能。
