---
layout: post
title: "一文了解 Dubbo 3 配置工作原理"
date: "2023-01-09T02:39:31.013Z"
---
一文了解 Dubbo 3 配置工作原理
===================
...
*   如果已存在相同id或name的实例，则框架会将这里的列出的属性作为已有实例配置的补充，详细请参考[属性覆盖](https://cn.dubbo.apache.org/zh/docs3-v2/java-sdk/reference-manual/config/principle#32-%E5%B1%9E%E6%80%A7%E8%A6%86%E7%9B%96)。
*   具体的配置复数形式请参考[单复数配置对照表](https://cn.dubbo.apache.org/zh/docs3-v2/java-sdk/reference-manual/config/principle#17-%E9%85%8D%E7%BD%AE%E9%A1%B9%E5%8D%95%E5%A4%8D%E6%95%B0%E5%AF%B9%E7%85%A7%E8%A1%A8)
...
dubbo.service.{interfaceName}.{methodName}.xxx=xxx  
...
*   Externalized Configuration，[外部化配置](https://cn.dubbo.apache.org/zh/docs3-v2/java-sdk/reference-manual/config/principle/#33-%E5%A4%96%E9%83%A8%E5%8C%96%E9%85%8D%E7%BD%AE)，从配置中心读取
...
![配置加载流程](https://img2023.cnblogs.com/other/3044349/202301/3044349-20230109073232639-1271543547.svg)

*   第一阶段为DubboBootstrap初始化之前，在Spring context启动时解析处理XML配置/注解配置/Java-config 或者是执行API配置代码，创建config bean并且加入到ConfigManager中。
*   第二阶段为DubboBootstrap初始化过程，从配置中心读取外部配置，依次处理实例级属性配置和应用级属性配置，最后刷新所有配置实例的属性，也就是[属性覆盖](https://cn.dubbo.apache.org/zh/docs3-v2/java-sdk/reference-manual/config/principle/#32-%E5%B1%9E%E6%80%A7%E8%A6%86%E7%9B%96)。
...
![覆盖关系](https://img2023.cnblogs.com/other/3044349/202301/3044349-20230109073233019-1466174191.jpg)
...
![属性覆盖流程](https://img2023.cnblogs.com/other/3044349/202301/3044349-20230109073233401-1970118026.svg)
...
*   优先级  
    外部化配置默认较本地配置有更高的优先级，因此这里配置的内容会覆盖本地配置值，关于各配置形式间的[覆盖关系](https://cn.dubbo.apache.org/zh/docs3-v2/java-sdk/reference-manual/config/principle/#21-%E8%A6%86%E7%9B%96%E5%85%B3%E7%B3%BB) 有单独一章说明。
...
![nacos-extenal-properties](https://img2023.cnblogs.com/other/3044349/202301/3044349-20230109073233955-571233621.png)
