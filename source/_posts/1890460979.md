...
本篇先对本项目功能、技术栈进行整体概述，再细节的讲述从0到1搭建 vue3-element-admin，在希望大家对本项目有个完完整整整了解的同时也能够在学 Vue3 + TypeScript 等技术栈少花些时间，少走些弯路，这样团队在毫无保留开源做的或许才有些许意义。
