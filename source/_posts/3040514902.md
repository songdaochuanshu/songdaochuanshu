---
layout: post
title: " 一起看 I/O | Flutter 3 更新详解"
date: "2022-05-26T12:39:00.275Z"
---
一起看 I/O | Flutter 3 更新详解
------------------------

_作者 / Kevin Jamaul Chisholm, Technical Program Manager for Dart and Flutter at Google_
...
![](https://devrel.andfun.cn/devrel/posts/2022/05/TCPW12.png)
...
_注意: 在 Windows 7 和 8 上依然可以运行 Flutter 应用，此更改只影响我们推荐使用的开发环境。_
...
使用 [google\_mobile\_ads](https://pub.flutter-io.cn/packages/google_mobile_ads) package 时，您应该可以感受到用户关键交互 (如页面之间的滚动和切换) 的性能有所提升。在新兴市场广为流行的设备上，这种性能提升尤其明显。最棒的是，您无需更改任何代码！
...
为了支持这些需求，Google 提供了 "用户消息平台 (User Messaging Platform, UMP)" SDK，取代了之前的开源 [Consent SDK](https://github.com/googleads/googleads-consent-sdk-ios)。在即将发布的 Google 移动广告 SDK (Flutter) 中，我们会增加对 UMP (用户消息平台) SDK 的支持，让发布商能够征求用户同意。如需了解详情，请在 pub.dev 上查看 [google\_mobile\_ads](https://pub.flutter-io.cn/packages/google_mobile_ads) package 页面。
...
posted on 2022-05-26 13:18  [Flutter社区](https://www.cnblogs.com/flutterdev/)  阅读(79)  评论(1)  [编辑](https://i.cnblogs.com/EditPosts.aspx?postid=16313130)  [收藏](javascript:void(0))  [举报](javascript:void(0))