---
layout: post
title: "netty系列之:netty中常用的对象编码解码器"
date: "2022-05-17T06:24:42.167Z"
---
...
*   [什么是序列化](#什么是序列化)
    ...
    *   [使用真正的加密](#使用真正的加密)
    *   [使用代理](#使用代理)
    *   [Serializable和Externalizable的区别](#serializable和externalizable的区别)
*   [netty中对象的传输](#netty中对象的传输)
    *   [ObjectEncoder](#objectencoder)
*   [ObjectDecoder](#objectdecoder)
*   [ObjectEncoderOutputStream和ObjectDecoderInputStream](#objectencoderoutputstream和objectdecoderinputstream)
*   [总结](#总结)
...
根据LengthFieldBasedFrameDecoder的定义，我们需要一个数组来保存真实数据的长度，这里使用的是一个4字节的byte数组叫做LENGTH\_PLACEHOLDER，如下所示：
...
> 本文已收录于 [http://www.flydean.com/14-8-netty-codec-object/](http://www.flydean.com/14-8-netty-codec-object/)
> 
