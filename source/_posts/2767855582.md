...
对于没有安装过Ollama的朋友，可以直接进入Ollama的官网： [https://ollama.com/](https://ollama.com/) 进行安装和下载。
...
Ollama支持很多models，我们可以在他的 [https://ollama.com/library](https://ollama.com/library) 网站中查找需要的模型。
...
如果你的ollama在本地，就填：[http://localhost:11434/](http://localhost:11434/)

如果是在其他远程的机子上，就填：[http://IP:11434/](http://IP:11434/)
