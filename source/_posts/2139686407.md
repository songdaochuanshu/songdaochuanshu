---
layout: post
title: "WPF 视频硬解码渲染播放（无空域）（支持4K、8K、高帧率视频）"
date: "2022-06-28T07:17:07.052Z"
---
...
**实现原理：**  
使用 [LibVLCSharp](https://code.videolan.org/videolan/LibVLCSharp) 库硬解码获取视频YUV420p（8bit、10bit）帧数据进行回调，采用[GLWpfControl](https://github.com/opentk/GLWpfControl) 控件用于呈现画面（该控件基于D3DImage，所以不存在空域问题）。  
...
[https://github.com/qian-o/MediaWPF](https://github.com/qian-o/MediaWPF)