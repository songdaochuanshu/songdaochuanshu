...
![图 1: OpenAI 的 Dall-E 2 在右下角加入了由 5 块不同颜色组成的可见水印。来源: instagram.com/dailydall.e](https://devrel.andfun.cn/devrel/posts/2024/02/28/N4nJPA.png)
...
![图 2: 例如 Imatag 和 Truepic 等公司已开发出将不可察觉的水印嵌入 AI 生成图像的技术。](https://devrel.andfun.cn/devrel/posts/2024/02/28/Hh711g.png)
...
![图 3: LLM 水印 Space 显示了合成文本上的红色和绿色令牌，代表这些是 AI 生成的概率。](https://devrel.andfun.cn/devrel/posts/2024/02/28/HmXAne.png)  
图片来源: [https://huggingface.co/spaces/tomg-group-umd/lm-watermarking](https://huggingface.co/spaces/tomg-group-umd/lm-watermarking)
...
![图 4 - AudioSeal 水印和检测的流程图。](https://devrel.andfun.cn/devrel/posts/2024/02/28/dX3z7O.png)  
来源：[https://github.com/facebookresearch/audioseal](https://github.com/facebookresearch/audioseal)
