---
layout: post
title: " 你真的了解 RSA 加密算法吗？"
date: "2022-12-06T01:19:05.073Z"
---
你真的了解 RSA 加密算法吗？
================
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-01.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-02.png)

![](https://bugstack.cn/images/article/algorithm/logic/primality-03.png)

三、算法公式推导
--------

![](https://bugstack.cn/images/article/algorithm/logic/primality-04.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-05.png?raw=true)

对于两个公式我们做一下更简单的转换；

![](https://bugstack.cn/images/article/algorithm/logic/primality-06.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-07.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-20.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-08.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-09.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-10.png?raw=true)

_孙子算经_ 中首次提到了同余方程组问题及其具体解法. 因此中国剩余定理称为孙子定理.

**定理 6** **中国余数定理** 令 m1,m2,…,mn 为大于 1 且两两互素的正整数, a1,a2,…,an 是任意整数. 则同余方程组

![](https://bugstack.cn/images/article/algorithm/logic/primality-11.png?raw=true)

有唯一的模 m=m1m2…mnm=m1m2…mn 的解.

**证明** 我们使用构造证明法, 构造出这个方程组的解. 首先对于 i=1,2,…,ni=1,2,…,n, 令

![](https://bugstack.cn/images/article/algorithm/logic/primality-12.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-13.png?raw=true)

上式等号两边同时乘 aiai 得

![](https://bugstack.cn/images/article/algorithm/logic/primality-14.png?raw=true)

就是第 i 个方程的一个解; 那么怎么构造出方程组的解呢? 我们注意到, 根据 Mi 的定义可得, 对所有的 j≠ij≠i, 都有 aiMiyi≡0(modmj). 因此我们令

![](https://bugstack.cn/images/article/algorithm/logic/primality-15.png?raw=true)

就是方程组的解.

有了这个结论, 我们可以解答 _孙子算经_ 中的问题了: 对方程组的每个方程, 求出 MiMi , 然后调用 `gcd(M_i, m_i)` 求出 yiyi:

![](https://bugstack.cn/images/article/algorithm/logic/primality-16.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-17.png?raw=true)

当 n 不为 p 或 0 时, 由于分子有质数p, 但分母不含p; 故分子的p能保留, 不被约分而除去. 即 p∣(np).

令 b 为任意整数, 根据二项式定理, 我们有

![](https://bugstack.cn/images/article/algorithm/logic/primality-18.png?raw=true)
...
![](https://bugstack.cn/images/article/algorithm/logic/primality-19.png?raw=true)
...
*   RSA算法原理： [https://www.ruanyifeng.com/blog/2013/07/rsa\_algorithm\_part\_two.html](https://www.ruanyifeng.com/blog/2013/07/rsa_algorithm_part_two.html)
...
*   莱昂哈德·欧拉：[https://en.wikipedia.org/wiki/Leonhard\_Euler](https://en.wikipedia.org/wiki/Leonhard_Euler)
