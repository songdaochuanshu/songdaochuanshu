---
layout: post
title: "netty系列之:我有一个可扩展的Enum你要不要看一下?"
date: "2022-06-06T12:37:57.534Z"
---
...
*   [简介](#简介)
*   [enum和Enum](#enum和enum)
*   [netty中可扩展的Enum:ConstantPool](#netty中可扩展的enumconstantpool)
*   [使用ConstantPool](#使用constantpool)
*   [总结](#总结)
...
> 更多内容请参考 [http://www.flydean.com/49-netty-extensible-enum/](http://www.flydean.com/49-netty-extensible-enum/)
> 
