...
*   **声明式 spec 篇**：LLM 产 Vega-Lite/ECharts spec，搭通用渲染器，含 schema 约束与 few-shot；
*   **组件树 GenUI 篇**：设计组件协议 + 白名单 registry，参考 AG-UI / A2UI；
*   **代码产物沙箱篇**：Artifacts 与 MCP Apps 的沙箱渲染；
*   **协议化篇**：AG-UI / MCP Apps / A2UI 跨平台解耦；
