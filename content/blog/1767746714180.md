...
项目主页: [https://github.com/emmett-framework/granian](https://github.com/emmett-framework/granian)
...
`--http1-buffer-size`、`--http1-keep-alive`

HTTP/2

`--http2-*` 一系列参数控制 flow control、窗口、keepalive、stream 数量等
