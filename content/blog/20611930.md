...
- 创建 OSS Bucket molio-releases（公共读、标准存储）

- 创建 OIDC Provider，信任 GitHub Actions，Audience 设为 sts.aliyuncs.com

- 创建 RAM Role GitHubActions-OSSUpload，信任策略限定 repo:zhuzhaoyun/Molio:*

- 附加最小权限策略：仅允许操作 molio-releases bucket
