...
> 作者：一航  
> GitHub：[jasonliyihang/speed\_tools](https://github.com/jasonliyihang/speed_tools)  
...
1.  新建 Android App 模块；
2.  在 `res/` 中放置与主工程**同名**的 `cxt_*` / `cxf_*` 资源；
3.  打包生成 APK。
...
1.  Application 是否初始化了 `SPThemeManager` 和 `SPFontManager`；
...
*   **GitHub 仓库**：[https://github.com/jasonliyihang/speed\_tools](https://github.com/jasonliyihang/speed_tools)
