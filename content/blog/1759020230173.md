...
17、[Termix](https://hellogithub.com/periodical/statistics/click?target=https://github.com/LukeGus/Termix)：高颜值一站式服务器管理平台。这是一个基于 Web 的服务器管理平台，集成了 SSH 终端、SSH 隧道、服务器监控和文件管理等功能。它完全免费开源、可自托管，支持自动重连、文件上传、分屏显示和语法高亮等特性。来自 [@DeShuiYu](https://hellogithub.com/user/ZWJkOqsvYbPgD8p) 的分享
