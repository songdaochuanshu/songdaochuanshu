---
layout: post
title: '从零实现富文本编辑器#10-React视图层适配器的模式扩展'
...
*   开源地址: [https://github.com/WindRunnerMax/BlockKit](https://github.com/WindRunnerMax/BlockKit)
*   在线编辑: [https://windrunnermax.github.io/BlockKit/](https://windrunnermax.github.io/BlockKit/)
*   项目笔记: [https://github.com/WindRunnerMax/BlockKit/blob/master/NOTE.md](https://github.com/WindRunnerMax/BlockKit/blob/master/NOTE.md)

**从零实现富文本编辑器系列文章**

*   [深感一无所长，准备试着从零开始写个富文本编辑器](https://www.cnblogs.com/WindrunnerMax/p/18816107)
*   [从零实现富文本编辑器#2-基于MVC模式的编辑器架构设计](https://www.cnblogs.com/WindrunnerMax/p/18826249)
*   [从零实现富文本编辑器#3-基于Delta的线性数据结构模型](https://www.cnblogs.com/WindrunnerMax/p/18840221)
*   [从零实现富文本编辑器#4-浏览器选区模型的核心交互策略](https://www.cnblogs.com/WindrunnerMax/p/18899981)
*   [从零实现富文本编辑器#5-编辑器选区模型的状态结构表达](https://www.cnblogs.com/WindrunnerMax/p/18921725)
*   [从零实现富文本编辑器#6-浏览器选区与编辑器选区模型同步](https://www.cnblogs.com/WindrunnerMax/p/19022750)
*   [从零实现富文本编辑器#7-基于组合事件的半受控输入模式](https://www.cnblogs.com/WindrunnerMax/p/19069539)
*   [从零实现富文本编辑器#8-浏览器输入模式的非受控DOM行为](https://www.cnblogs.com/WindrunnerMax/p/19152103)
*   [从零实现富文本编辑器#9-编辑器文本结构变更的受控处理](https://www.cnblogs.com/WindrunnerMax/p/19381254)
*   从零实现富文本编辑器#10-React视图层适配器的模式扩展
...
*   [https://18.react.dev/](https://18.react.dev/)
*   [https://zh-hans.react.dev/reference/react/useImperativeHandle](https://zh-hans.react.dev/reference/react/useImperativeHandle)
*   [https://developer.mozilla.org/en-US/docs/Glossary/Character\_reference](https://developer.mozilla.org/en-US/docs/Glossary/Character_reference)