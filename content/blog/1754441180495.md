---
layout: post
title: '从零实现富文本编辑器#6-浏览器选区与编辑器选区模型同步'
...
%%{init: {"theme": "neutral" } }%% flowchart LR DOMRange -.-> ToModelRange\["toModelRange()"\] -.-> DOMPoint DOMPoint --> NormalizeDOMPoint\["normalizeDOMPoint()"\] --> ToModelPoint ToModelPoint\["toModelPoint()"\] --> ModelPoint ModelRange -.-> ToDOMRange\["toDOMRange()"\] -.-> ModelPoint ModelPoint --> ToDOMPoint\["toDOMPoint()"\] --> |NormalizeDOMPoint| DOMPoint
...
*   [https://quilljs.com/docs/api#selection](https://quilljs.com/docs/api#selection)
*   [https://lexical.dev/docs/concepts/selection](https://lexical.dev/docs/concepts/selection)
*   [https://docs.slatejs.org/concepts/03-locations#selection](https://docs.slatejs.org/concepts/03-locations#selection)