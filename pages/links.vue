    ...
    <main class="pt-24 pb-16 px-4">
      <div class="max-w-4xl mx-auto">
        ...
        <div v-else-if="error" class="text-center py-12">
          ...
          <button @click="fetchLinks" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
            重试
          </button>
        </div>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <a
            ...
            class="group block bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600"
          >
            <div class="p-6">
              <div class="flex items-start gap-4">
                <img
                  :src="link.avatar"
                  :alt="link.name"
                  class="w-12 h-12 rounded-full bg-gray-200 dark:bg-gray-700 flex-shrink-0"
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <span v-if="link.category" class="inline-block mt-2 px-2 py-0.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded">
                    {{ link.category }}
                  </span>
                </div>
              </div>
