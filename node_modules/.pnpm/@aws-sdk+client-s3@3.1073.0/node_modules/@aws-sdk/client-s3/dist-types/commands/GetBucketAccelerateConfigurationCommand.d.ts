...
declare const GetBucketAccelerateConfigurationCommand_base: {
    new (input: GetBucketAccelerateConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAccelerateConfigurationCommandInput, GetBucketAccelerateConfigurationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetBucketAccelerateConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketAccelerateConfigurationCommandInput, GetBucketAccelerateConfigurationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
