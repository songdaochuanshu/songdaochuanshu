  ...
  setup(nuxtApp) {
    ...
    function checkIfLayoutUsed() {
      if (!error.value && !nuxtApp._isNuxtLayoutUsed && Object.keys(layouts).length > 0) {
        console.warn(
          "[nuxt] Your project has layouts but `<NuxtLayout />` has not been detected. Make sure you are using `<NuxtLayout />` in your app to render layouts. If `<NuxtLayout />` is rendered conditionally, this warning can be triggered before it is mounted."
        );
      }
    }
