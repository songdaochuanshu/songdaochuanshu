...
const R2API = __importStar(require("./r2/r2.js"));
class EventNotifications extends resource_1.APIResource {
    constructor() {
        super(...arguments);
        this.r2 = new R2API.R2(this._client);
    }
}
exports.EventNotifications = EventNotifications;
(function (EventNotifications) {
    EventNotifications.R2 = R2API.R2;
})(EventNotifications = exports.EventNotifications || (exports.EventNotifications = {}));
